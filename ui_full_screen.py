...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_ontop = QCheckBox(self.rightButtons)
        self.checkBox_ontop.setObjectName(u"checkBox_ontop")

        self.horizontalLayout_2.addWidget(self.checkBox_ontop)
        ...
        self.miniButton.setStyleSheet(u"border:None;")
        icon = QIcon()
        ...
        self.maxiButton.setStyleSheet(u"border:None;")
        icon1 = QIcon()
...
"#rightButtons .QPushButton:pressed { background-color: rgb(23, 26, 30); border-style: solid; border-radius: 4px; }")
        ...
        self.n_image = QLabel(self.centralwidget)
        self.n_image.setObjectName(u"n_image")
        self.n_image.setMinimumSize(QSize(640, 480))
        ...
        self.verticalLayout.addWidget(self.n_image)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_ontop.setText(QCoreApplication.translate("MainWindow", u"Always on top", None))
