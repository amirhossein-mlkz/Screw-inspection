...
if __name__ == '__main__':
    ...
    collector = Collector('23905933',exposure=100, gain=10, trigger=False, delay_packet=81062,\
        packet_size=9000,frame_transmission_delay=18036,height=1000,width=1000,offet_x=16,offset_y=4,manual=False,list_devices_mode=False)
