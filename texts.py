...
WARNINGS={
        ...
        'path_eror_plc':{'fa':'ادرس اشتباه ',
             'en':'Path Eror'},
          'camrea_connection_ok':{'fa':'اتصال برقرار شد',
               'en':'Cameras Connection Successfully'},
          'camrea_connection_not_ok':{'fa':'مشکل در اتصال',
               'en':'Cameras Connection Eror'},  
          'close_win':{'fa':'آیا از خروج اطمینان دارید؟',
                         'en':'Are you sure want to close ?'},
          'reset':{'fa':'آیا اطمینان دارید ؟',
                    'en':'Are you sure want to restrt ?'}
}
MESSEGES = {
...
#     self.pushButton_5.setText(Titles['Side Camera'][lang])
     self.add_btn.setText(Titles['Add'][lang])
