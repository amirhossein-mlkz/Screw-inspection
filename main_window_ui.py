...
"}")
        ...
        self.side_detection_mode_btn = QPushButton(self.topMenu)
        self.side_detection_mode_btn.setObjectName(u"side_detection_mode_btn")
        self.side_detection_mode_btn.setEnabled(True)
        sizePolicy.setHeightForWidth(self.side_detection_mode_btn.sizePolicy().hasHeightForWidth())
        self.side_detection_mode_btn.setSizePolicy(sizePolicy)
        self.side_detection_mode_btn.setMinimumSize(QSize(0, 45))
        self.side_detection_mode_btn.setFont(font1)
        self.side_detection_mode_btn.setCursor(QCursor(Qt.PointingHandCursor))
        self.side_detection_mode_btn.setLayoutDirection(Qt.LeftToRight)
        icon5 = QIcon()
        icon5.addFile(u"images/setting_main_window/sensor_setting_orange.png", QSize(), QIcon.Normal, QIcon.Off)
        self.side_detection_mode_btn.setIcon(icon5)
        self.side_detection_mode_btn.setIconSize(QSize(35, 35))

        self.verticalLayout_8.addWidget(self.side_detection_mode_btn)
        ...
        icon6 = QIcon()
        icon6.addFile(u"images/setting_main_window/users_setting_orange.png", QSize(), QIcon.Normal, QIcon.Off)
        self.side_users_setting_btn.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u"images/setting_main_window/general_setting_orange.png", QSize(), QIcon.Normal, QIcon.Off)
        self.side_general_setting_btn.setIcon(icon7)
        self.side_general_setting_btn.setIconSize(QSize(35, 35))

        self.verticalLayout_8.addWidget(self.side_general_setting_btn)

        self.history_btn = QPushButton(self.topMenu)
        ...
        self.history_btn.setMinimumSize(QSize(0, 45))
        self.history_btn.setFont(font1)
        self.history_btn.setCursor(QCursor(Qt.PointingHandCursor))
        self.history_btn.setLayoutDirection(Qt.LeftToRight)
        icon8 = QIcon()
        icon8.addFile(u"images/database.png", QSize(), QIcon.Normal, QIcon.Off)
        self.history_btn.setIcon(icon8)
        self.history_btn.setIconSize(QSize(35, 35))

        self.verticalLayout_8.addWidget(self.history_btn)
        ...
        self.main_login_btn.setEnabled(False)
        ...
        icon9 = QIcon()
        icon9.addFile(u"../../home/milad/.designer/backup/images/login_white.png", QSize(), QIcon.Normal, QIcon.Off)
        self.main_login_btn.setIcon(icon9)
...
"text-align:left;")
        ...
        self.contentTopBg.setMinimumSize(QSize(0, 27))
        self.contentTopBg.setMaximumSize(QSize(16777215, 34))
...
"}")
        icon10 = QIcon()
        icon10.addFile(u"../../home/milad/.designer/backup/images/enter.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.toogle_btn_2 = QPushButton(self.rightButtons)
        self.toogle_btn_2.setObjectName(u"toogle_btn_2")
        self.toogle_btn_2.setEnabled(True)
        self.toogle_btn_2.setMinimumSize(QSize(0, 0))
        self.toogle_btn_2.setMaximumSize(QSize(0, 100))
        self.toogle_btn_2.setStyleSheet(u"")
        icon11 = QIcon()
        icon11.addFile(u"images/setting_main_window/toogle_left.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toogle_btn_2.setIcon(icon11)
        self.toogle_btn_2.setIconSize(QSize(15, 15))

        self.horizontalLayout_2.addWidget(self.toogle_btn_2)
        ...
        icon12 = QIcon()
        icon12.addFile(u"images/icons/cil-minus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.miniButton.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u"images/icons/cil-rectangle.png", QSize(), QIcon.Normal, QIcon.Off)
        self.maxiButton.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u"images/icons/cil-x.png", QSize(), QIcon.Normal, QIcon.Off)
        self.closeButton.setIcon(icon14)
...
"}")
        ...
        self.verticalLayout_19.setContentsMargins(0, 3, 0, 2)
        ...
        self.frame_231 = QFrame(self.frame_139)
        ...
        self.horizontalLayout_78 = QHBoxLayout(self.frame_231)
        self.horizontalLayout_78.setSpacing(0)
        self.horizontalLayout_78.setObjectName(u"horizontalLayout_78")
        self.horizontalLayout_78.setContentsMargins(0, 0, 0, 0)
        self.frame_45 = QFrame(self.frame_231)
        self.frame_45.setObjectName(u"frame_45")
        self.frame_45.setMinimumSize(QSize(86, 0))
        self.frame_45.setMaximumSize(QSize(86, 16777215))
        self.frame_45.setFrameShape(QFrame.Box)
        self.frame_45.setFrameShadow(QFrame.Sunken)
        self.verticalLayout_4 = QVBoxLayout(self.frame_45)
        ...
        self.line_37 = QFrame(self.frame_45)
        ...
        self.btn_enabel_mask_draw_live_side.setEnabled(False)
        self.btn_enabel_mask_draw_live_side.setMaximumSize(QSize(24, 16777215))
        self.btn_enabel_mask_draw_live_side.setStyleSheet(u"QCheckBox::indicator:disabled  {\n"
"	background-color:rgb(240, 240, 240);\n"
"border-color:rgb(213, 213, 213);; \n"
"}\n"
"")

        self.verticalLayout_4.addWidget(self.btn_enabel_mask_draw_live_side, 0, Qt.AlignHCenter)

        self.line_38 = QFrame(self.frame_45)
        self.line_38.setObjectName(u"line_38")
        self.line_38.setFrameShape(QFrame.HLine)
        self.line_38.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_4.addWidget(self.line_38)

        self.btn_save_side_cam_live_page = QPushButton(self.frame_45)
        self.btn_save_side_cam_live_page.setObjectName(u"btn_save_side_cam_live_page")
        self.btn_save_side_cam_live_page.setMaximumSize(QSize(45, 39))
        ...
        icon15 = QIcon()
        icon15.addFile(u"images/download.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_save_side_cam_live_page.setIcon(icon15)
        self.btn_save_side_cam_live_page.setIconSize(QSize(26, 32))

        self.verticalLayout_4.addWidget(self.btn_save_side_cam_live_page, 0, Qt.AlignHCenter)


        self.horizontalLayout_78.addWidget(self.frame_45, 0, Qt.AlignLeft|Qt.AlignTop)

        self.label_img_side_live = QLabel(self.frame_231)
        self.label_img_side_live.setObjectName(u"label_img_side_live")
        self.label_img_side_live.setMinimumSize(QSize(300, 373))
        ...
        self.horizontalLayout_78.addWidget(self.label_img_side_live, 0, Qt.AlignHCenter|Qt.AlignVCenter)


        self.verticalLayout_20.addWidget(self.frame_231)

        self.line_21 = QFrame(self.frame_139)
        ...
        self.verticalLayout_19.addWidget(self.frame_139)
        ...
        self.frame_147 = QFrame(self.frame_22)
        self.frame_147.setObjectName(u"frame_147")
        self.frame_147.setMinimumSize(QSize(86, 0))
        self.frame_147.setMaximumSize(QSize(86, 16777215))
        self.frame_147.setFrameShape(QFrame.Box)
        self.frame_147.setFrameShadow(QFrame.Sunken)
        self.verticalLayout_21 = QVBoxLayout(self.frame_147)
        ...
        self.line_41 = QFrame(self.frame_147)
        ...
        self.btn_enabel_mask_draw_live_top = QCheckBox(self.frame_147)
        self.btn_enabel_mask_draw_live_top.setObjectName(u"btn_enabel_mask_draw_live_top")
        self.btn_enabel_mask_draw_live_top.setEnabled(False)
        self.btn_enabel_mask_draw_live_top.setMaximumSize(QSize(24, 16777215))
        self.btn_enabel_mask_draw_live_top.setStyleSheet(u"QCheckBox::indicator:disabled  {\n"
"	background-color:rgb(240, 240, 240);\n"
"border-color:rgb(213, 213, 213);; \n"
"}\n"
"")

        self.verticalLayout_21.addWidget(self.btn_enabel_mask_draw_live_top, 0, Qt.AlignHCenter)

        self.line_42 = QFrame(self.frame_147)
        self.line_42.setObjectName(u"line_42")
        self.line_42.setFrameShape(QFrame.HLine)
        self.line_42.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_21.addWidget(self.line_42)

        self.btn_save_top_cam_live_page = QPushButton(self.frame_147)
        self.btn_save_top_cam_live_page.setObjectName(u"btn_save_top_cam_live_page")
        self.btn_save_top_cam_live_page.setMaximumSize(QSize(45, 39))
        ...
        self.btn_save_top_cam_live_page.setIcon(icon15)
        self.btn_save_top_cam_live_page.setIconSize(QSize(26, 32))

        self.verticalLayout_21.addWidget(self.btn_save_top_cam_live_page, 0, Qt.AlignHCenter)


        self.horizontalLayout_18.addWidget(self.frame_147, 0, Qt.AlignLeft|Qt.AlignTop)

        self.label_img_top_live = QLabel(self.frame_22)
        self.label_img_top_live.setObjectName(u"label_img_top_live")
        self.label_img_top_live.setMinimumSize(QSize(300, 374))
        self.label_img_top_live.setMaximumSize(QSize(16777215, 16777215))
        self.label_img_top_live.setSizeIncrement(QSize(1, 3))
        ...
        self.horizontalLayout_18.addWidget(self.label_img_top_live, 0, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.frame_67.setMinimumSize(QSize(390, 0))
        ...
        self.frame_229 = QFrame(self.frame_67)
        ...
        self.horizontalLayout_89 = QHBoxLayout(self.frame_229)
        self.horizontalLayout_89.setObjectName(u"horizontalLayout_89")
        self.horizontalLayout_89.setContentsMargins(0, 0, -1, 0)
        self.frame_18 = QFrame(self.frame_229)
        self.frame_18.setObjectName(u"frame_18")
        sizePolicy1.setHeightForWidth(self.frame_18.sizePolicy().hasHeightForWidth())
        self.frame_18.setSizePolicy(sizePolicy1)
        self.frame_18.setMinimumSize(QSize(389, 265))
        ...
        self.frame_64.setMinimumSize(QSize(0, 52))
        self.frame_64.setFrameShape(QFrame.StyledPanel)
        self.frame_64.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_70 = QHBoxLayout(self.frame_64)
        self.horizontalLayout_70.setObjectName(u"horizontalLayout_70")
        self.horizontalLayout_70.setContentsMargins(0, -1, -1, -1)
        ...
        self.connect_cameras_live_page.setEnabled(False)
        self.connect_cameras_live_page.setMinimumSize(QSize(140, 32))
        self.connect_cameras_live_page.setMaximumSize(QSize(140, 32))
...
"}")
        ...
        self.connect_cameras_live_page.setIcon(icon16)
        ...
        self.disconnect_cameras_live_page.setMinimumSize(QSize(140, 32))
        self.disconnect_cameras_live_page.setMaximumSize(QSize(139, 32))
...
"}")
        icon17 = QIcon()
        icon17.addFile(u"images/connect.png", QSize(), QIcon.Normal, QIcon.Off)
        self.disconnect_cameras_live_page.setIcon(icon17)
        ...
        self.line_44 = QFrame(self.frame_18)
        self.line_44.setObjectName(u"line_44")
        self.line_44.setFrameShape(QFrame.HLine)
        self.line_44.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_58.addWidget(self.line_44)

        self.groupBox_14 = QGroupBox(self.frame_18)
        self.groupBox_14.setObjectName(u"groupBox_14")
        self.groupBox_14.setMinimumSize(QSize(0, 41))
        ...
        self.horizontalLayout_182.addItem(self.horizontalSpacer_35)
        ...
        self.horizontalLayout_182.addItem(self.horizontalSpacer_36)

        self.label_183 = QLabel(self.groupBox_14)
        self.label_183.setObjectName(u"label_183")
        self.label_183.setMaximumSize(QSize(40, 16777215))

        self.horizontalLayout_182.addWidget(self.label_183)

        self.reject_btn = QPushButton(self.groupBox_14)
        self.reject_btn.setObjectName(u"reject_btn")
        self.reject_btn.setMinimumSize(QSize(42, 32))
        self.reject_btn.setMaximumSize(QSize(20, 32))
        self.reject_btn.setCursor(QCursor(Qt.PointingHandCursor))
        self.reject_btn.setStyleSheet(u"QPushButton {\n"
"	background-color: rgb(255, 170, 255);\n"
"	border: 2px solid rgb(61, 70, 86);\n"
"}")
        self.reject_btn.setIconSize(QSize(41, 26))

        self.horizontalLayout_182.addWidget(self.reject_btn)

        self.horizontalSpacer_41 = QSpacerItem(20, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.horizontalLayout_182.addItem(self.horizontalSpacer_41)
        ...
        self.frame_62.setMinimumSize(QSize(0, 27))
        self.frame_62.setMaximumSize(QSize(16777215, 43))
        ...
        self.combobox_select_screw_live.setMinimumSize(QSize(0, 25))
        ...
        self.frame_228 = QFrame(self.frame_18)
        ...
        self.label_156 = QLabel(self.frame_228)
        self.label_156.setObjectName(u"label_156")
        self.label_156.setMinimumSize(QSize(28, 0))
        self.label_156.setMaximumSize(QSize(28, 16777215))

        self.horizontalLayout_10.addWidget(self.label_156)

        self.label_selected_screw_top_live = QLabel(self.frame_228)
        self.label_selected_screw_top_live.setObjectName(u"label_selected_screw_top_live")
        sizePolicy2 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.label_selected_screw_top_live.sizePolicy().hasHeightForWidth())
        self.label_selected_screw_top_live.setSizePolicy(sizePolicy2)
        self.label_selected_screw_top_live.setMinimumSize(QSize(120, 100))
        self.label_selected_screw_top_live.setMaximumSize(QSize(120, 100))
        ...
        self.horizontalLayout_10.addWidget(self.label_selected_screw_top_live)
        ...
        self.label_158 = QLabel(self.frame_228)
        self.label_158.setObjectName(u"label_158")
        self.label_158.setMinimumSize(QSize(33, 0))
        self.label_158.setMaximumSize(QSize(33, 16777215))

        self.horizontalLayout_10.addWidget(self.label_158)

        self.label_selected_screw_side_live = QLabel(self.frame_228)
        self.label_selected_screw_side_live.setObjectName(u"label_selected_screw_side_live")
        sizePolicy2.setHeightForWidth(self.label_selected_screw_side_live.sizePolicy().hasHeightForWidth())
        self.label_selected_screw_side_live.setSizePolicy(sizePolicy2)
        self.label_selected_screw_side_live.setMinimumSize(QSize(120, 100))
        self.label_selected_screw_side_live.setMaximumSize(QSize(120, 100))
        ...
        self.horizontalLayout_10.addWidget(self.label_selected_screw_side_live)

        self.horizontalSpacer_45 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_10.addItem(self.horizontalSpacer_45)


        self.verticalLayout_58.addWidget(self.frame_228)
        ...
        self.horizontalLayout_89.addWidget(self.frame_18)

        self.line_43 = QFrame(self.frame_229)
        self.line_43.setObjectName(u"line_43")
        self.line_43.setFrameShape(QFrame.VLine)
        self.line_43.setFrameShadow(QFrame.Sunken)

        self.horizontalLayout_89.addWidget(self.line_43)

        self.frame_230 = QFrame(self.frame_229)
        self.frame_230.setObjectName(u"frame_230")
        self.frame_230.setMinimumSize(QSize(210, 0))
        self.frame_230.setMaximumSize(QSize(210, 16777215))
        self.frame_230.setFrameShape(QFrame.StyledPanel)
        self.frame_230.setFrameShadow(QFrame.Raised)
        self.verticalLayout_144 = QVBoxLayout(self.frame_230)
        self.verticalLayout_144.setObjectName(u"verticalLayout_144")
        self.start_capture_live_page = QPushButton(self.frame_230)
        self.start_capture_live_page.setObjectName(u"start_capture_live_page")
        self.start_capture_live_page.setEnabled(True)
        self.start_capture_live_page.setMinimumSize(QSize(0, 90))
        self.start_capture_live_page.setMaximumSize(QSize(16777215, 90))
        font3 = QFont()
        font3.setPointSize(28)
        self.start_capture_live_page.setFont(font3)
        self.start_capture_live_page.setCursor(QCursor(Qt.PointingHandCursor))
        self.start_capture_live_page.setStyleSheet(u"QPushButton {\n"
"    color: #333;\n"
...
"        radius: 1.35, stop: 0 #4ff78d, stop: 1 #0eb54c\n"
"        );\n"
"    padding: 5px;\n"
"	font-size:28pt;\n"
"    }\n"
...
"    background: qradialgradient(\n"
"        cx: 0.3, cy: -0.4, fx: 0.3, fy: -0.4,\n"
"        radius: 1.35, stop: 0 #3be379, stop: 1 #00fc0d\n"
"        );\n"
"    }\n"
"\n"
"QPushButton:pressed {\n"
...
"\n"
"	background-color: rgb(109, 147, 118);	\n"
"	font-size:15pt;\n"
"}")
        self.start_capture_live_page.setIconSize(QSize(41, 26))

        self.verticalLayout_144.addWidget(self.start_capture_live_page)

        self.stop_capture_live_page = QPushButton(self.frame_230)
        self.stop_capture_live_page.setObjectName(u"stop_capture_live_page")
        self.stop_capture_live_page.setEnabled(False)
        self.stop_capture_live_page.setMinimumSize(QSize(0, 90))
        self.stop_capture_live_page.setMaximumSize(QSize(16777215, 90))
        self.stop_capture_live_page.setFont(font3)
        self.stop_capture_live_page.setCursor(QCursor(Qt.PointingHandCursor))
        self.stop_capture_live_page.setStyleSheet(u"QPushButton {\n"
"    color: #333;\n"
"    border: 2px solid #555;\n"
"    border-radius: 40px;\n"
"    border-style: outset;\n"
"    background: qradialgradient(\n"
"        cx: 0.3, cy: -0.4, fx: 0.3, fy: -0.4,\n"
"        radius: 1.35, stop: 0 #f74848, stop: 1 #e80505\n"
"        );\n"
"    padding: 5px;\n"
"	font-size:28pt;\n"
"    }\n"
...
"    background: qradialgradient(\n"
"        cx: 0.3, cy: -0.4, fx: 0.3, fy: -0.4,\n"
"        radius: 1.35, stop: 0 #f51b1b, stop: 1 #fc0000\n"
"        );\n"
"    }\n"
"\n"
"QPushButton:pressed {\n"
...
"}")
        ...
        self.verticalLayout_144.addWidget(self.stop_capture_live_page)


        self.horizontalLayout_89.addWidget(self.frame_230, 0, Qt.AlignRight)


        self.verticalLayout_23.addWidget(self.frame_229)
...
"")
        ...
        self.groupBox_19 = QGroupBox(self.groupBox_21)
        ...
        self.table_live_top_live_page.setMaximumSize(QSize(16777215, 16777215))
...
"")
        ...
        self.verticalLayout_137.addWidget(self.groupBox_19)
...
"}")
        ...
        self.label_status_mode.setFont(font5)
        ...
        self.frame_239 = QFrame(self.groupBox_23)
        self.frame_239.setObjectName(u"frame_239")
        self.frame_239.setEnabled(False)
        self.frame_239.setFrameShape(QFrame.StyledPanel)
        self.frame_239.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_207 = QHBoxLayout(self.frame_239)
        self.horizontalLayout_207.setObjectName(u"horizontalLayout_207")
        self.checkbox_page0_0_top = QCheckBox(self.frame_239)
        self.checkbox_page0_0_top.setObjectName(u"checkbox_page0_0_top")
        self.checkbox_page0_0_top.setCursor(QCursor(Qt.PointingHandCursor))
        self.checkbox_page0_0_top.setChecked(True)

        self.horizontalLayout_207.addWidget(self.checkbox_page0_0_top)

        self.btn_page0_0_top = QPushButton(self.frame_239)
        self.btn_page0_0_top.setObjectName(u"btn_page0_0_top")
        self.btn_page0_0_top.setEnabled(False)
        self.btn_page0_0_top.setMinimumSize(QSize(100, 25))
        self.btn_page0_0_top.setMaximumSize(QSize(100, 16777215))
        self.btn_page0_0_top.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_page0_0_top.setStyleSheet(u"QPushButton:enabled { \n"
"	background-color: rgb(255,255,255);\n"
"	color: black;\n"
"}\n"
"\n"
...
"	color: white;\n"
"}")
        self.btn_page0_0_top.setCheckable(False)
        self.btn_page0_0_top.setChecked(False)

        self.horizontalLayout_207.addWidget(self.btn_page0_0_top)


        self.verticalLayout_62.addWidget(self.frame_239)
        ...
        self.checkbox_page0_1_top.setEnabled(True)
        self.checkbox_page0_1_top.setCursor(QCursor(Qt.PointingHandCursor))
        self.checkbox_page0_1_top.setChecked(False)
...
"}")
        ...
        self.checkbox_page0_3_side.setChecked(False)
...
"}")
        ...
        self.stackedWidget_2.setMaximumSize(QSize(16777215, 16777194))
        self.page_0_top = QWidget()
        self.page_0_top.setObjectName(u"page_0_top")
        self.verticalLayout_145 = QVBoxLayout(self.page_0_top)
        self.verticalLayout_145.setObjectName(u"verticalLayout_145")
        self.frame_29 = QFrame(self.page_0_top)
        ...
        self.line_img_path0_1_top.setMinimumSize(QSize(193, 0))
        ...
        self.verticalLayout_145.addWidget(self.frame_29)

        self.frame_238 = QFrame(self.page_0_top)
        ...
        self.verticalLayout_138 = QVBoxLayout(self.frame_238)
        self.verticalLayout_138.setObjectName(u"verticalLayout_138")
        self.frame_235 = QFrame(self.frame_238)
        ...
        self.horizontalLayout_205 = QHBoxLayout(self.frame_235)
        self.horizontalLayout_205.setObjectName(u"horizontalLayout_205")
        self.label_206 = QLabel(self.frame_235)
        self.label_206.setObjectName(u"label_206")
        self.label_206.setMaximumSize(QSize(20, 20))
        self.label_206.setStyleSheet(u"background-color: rgb(255, 0, 0);\n"
"border-radius : 5px;")

        self.horizontalLayout_205.addWidget(self.label_206)

        self.label_202 = QLabel(self.frame_235)
        self.label_202.setObjectName(u"label_202")

        self.horizontalLayout_205.addWidget(self.label_202)

        self.spin_lbelt_0_top = QSpinBox(self.frame_235)
        self.spin_lbelt_0_top.setObjectName(u"spin_lbelt_0_top")
        self.spin_lbelt_0_top.setMaximum(20000)
        self.spin_lbelt_0_top.setSingleStep(50)
        self.spin_lbelt_0_top.setValue(10)

        self.horizontalLayout_205.addWidget(self.spin_lbelt_0_top)


        self.verticalLayout_138.addWidget(self.frame_235)

        self.line_48 = QFrame(self.frame_238)
        self.line_48.setObjectName(u"line_48")
        self.line_48.setFrameShape(QFrame.HLine)
        self.line_48.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_138.addWidget(self.line_48)

        self.frame_236 = QFrame(self.frame_238)
        ...
        self.horizontalLayout_206 = QHBoxLayout(self.frame_236)
        self.horizontalLayout_206.setObjectName(u"horizontalLayout_206")
        self.label_207 = QLabel(self.frame_236)
        self.label_207.setObjectName(u"label_207")
        self.label_207.setMaximumSize(QSize(20, 20))
        self.label_207.setStyleSheet(u"background-color: rgb(0, 255, 0);\n"
"border-radius : 5px;")

        self.horizontalLayout_206.addWidget(self.label_207)

        self.label_204 = QLabel(self.frame_236)
        self.label_204.setObjectName(u"label_204")

        self.horizontalLayout_206.addWidget(self.label_204)

        self.spin_rbelt_0_top = QSpinBox(self.frame_236)
        self.spin_rbelt_0_top.setObjectName(u"spin_rbelt_0_top")
        self.spin_rbelt_0_top.setMaximum(2000)
        self.spin_rbelt_0_top.setSingleStep(50)
        self.spin_rbelt_0_top.setValue(10)

        self.horizontalLayout_206.addWidget(self.spin_rbelt_0_top)


        self.verticalLayout_138.addWidget(self.frame_236)

        self.line_49 = QFrame(self.frame_238)
        self.line_49.setObjectName(u"line_49")
        self.line_49.setFrameShape(QFrame.HLine)
        self.line_49.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_138.addWidget(self.line_49)

        self.frame_237 = QFrame(self.frame_238)
        ...
        self.horizontalLayout_204 = QHBoxLayout(self.frame_237)
        self.horizontalLayout_204.setObjectName(u"horizontalLayout_204")
        self.label_205 = QLabel(self.frame_237)
        self.label_205.setObjectName(u"label_205")

        self.horizontalLayout_204.addWidget(self.label_205)

        self.spin_angle_0_top = QDoubleSpinBox(self.frame_237)
        self.spin_angle_0_top.setObjectName(u"spin_angle_0_top")
        self.spin_angle_0_top.setDecimals(1)
        self.spin_angle_0_top.setMinimum(-90.000000000000000)
        self.spin_angle_0_top.setMaximum(90.000000000000000)
        self.spin_angle_0_top.setSingleStep(0.100000000000000)
        self.spin_angle_0_top.setValue(0.000000000000000)

        self.horizontalLayout_204.addWidget(self.spin_angle_0_top)


        self.verticalLayout_138.addWidget(self.frame_237)

        self.verticalSpacer_14 = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.verticalLayout_138.addItem(self.verticalSpacer_14)


        self.verticalLayout_145.addWidget(self.frame_238)

        self.stackedWidget_2.addWidget(self.page_0_top)
        ...
        self.frame_49.setMinimumSize(QSize(0, 105))
        ...
        self.frame_243 = QFrame(self.frame_32)
        ...
        self.horizontalLayout_211 = QHBoxLayout(self.frame_243)
        self.horizontalLayout_211.setObjectName(u"horizontalLayout_211")
        self.check_thresh_algo_1_top = QCheckBox(self.frame_243)
        self.check_thresh_algo_1_top.setObjectName(u"check_thresh_algo_1_top")

        self.horizontalLayout_211.addWidget(self.check_thresh_algo_1_top)

        self.check_edge_algo_1_top = QCheckBox(self.frame_243)
        self.check_edge_algo_1_top.setObjectName(u"check_edge_algo_1_top")

        self.horizontalLayout_211.addWidget(self.check_edge_algo_1_top)


        self.verticalLayout_34.addWidget(self.frame_243)

        self.stackedWidget_4 = QStackedWidget(self.frame_32)
        self.stackedWidget_4.setObjectName(u"stackedWidget_4")
        self.stackedWidget_4.setMaximumSize(QSize(16777215, 197))
        self.page_edge = QWidget()
        self.page_edge.setObjectName(u"page_edge")
        self.verticalLayout_147 = QVBoxLayout(self.page_edge)
        self.verticalLayout_147.setObjectName(u"verticalLayout_147")
        self.frame_244 = QFrame(self.page_edge)
        self.frame_244.setObjectName(u"frame_244")
        self.frame_244.setMinimumSize(QSize(0, 178))
        self.frame_244.setMaximumSize(QSize(16777215, 178))
        self.frame_244.setFrameShape(QFrame.StyledPanel)
        self.frame_244.setFrameShadow(QFrame.Raised)
        self.verticalLayout_148 = QVBoxLayout(self.frame_244)
        self.verticalLayout_148.setObjectName(u"verticalLayout_148")
        self.verticalLayout_148.setContentsMargins(-1, 0, -1, 0)
        self.label_160 = QLabel(self.frame_244)
        self.label_160.setObjectName(u"label_160")
        self.label_160.setMinimumSize(QSize(88, 0))
        self.label_160.setMaximumSize(QSize(16777215, 29))

        self.verticalLayout_148.addWidget(self.label_160)

        self.frame_245 = QFrame(self.frame_244)
        self.frame_245.setObjectName(u"frame_245")
        self.frame_245.setMinimumSize(QSize(0, 27))
        self.frame_245.setMaximumSize(QSize(16777215, 27))
        self.frame_245.setFrameShape(QFrame.StyledPanel)
        self.frame_245.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_212 = QHBoxLayout(self.frame_245)
        self.horizontalLayout_212.setObjectName(u"horizontalLayout_212")
        self.horizontalLayout_212.setContentsMargins(-1, 0, -1, 0)
        self.bar_edge_thresh0_1_top = QSlider(self.frame_245)
        self.bar_edge_thresh0_1_top.setObjectName(u"bar_edge_thresh0_1_top")
        self.bar_edge_thresh0_1_top.setMinimumSize(QSize(0, 30))
        self.bar_edge_thresh0_1_top.setMinimum(1)
        self.bar_edge_thresh0_1_top.setMaximum(50)
        self.bar_edge_thresh0_1_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_212.addWidget(self.bar_edge_thresh0_1_top)

        self.spinBox_27 = QSpinBox(self.frame_245)
        self.spinBox_27.setObjectName(u"spinBox_27")
        self.spinBox_27.setMaximum(255)

        self.horizontalLayout_212.addWidget(self.spinBox_27)


        self.verticalLayout_148.addWidget(self.frame_245)

        self.frame_242 = QFrame(self.frame_244)
        self.frame_242.setObjectName(u"frame_242")
        self.frame_242.setMaximumSize(QSize(16777215, 43))
        self.frame_242.setFrameShape(QFrame.StyledPanel)
        self.frame_242.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_210 = QHBoxLayout(self.frame_242)
        self.horizontalLayout_210.setObjectName(u"horizontalLayout_210")
        self.label_5 = QLabel(self.frame_242)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setMinimumSize(QSize(100, 0))

        self.horizontalLayout_210.addWidget(self.label_5)

        self.spin_belt_edge_margin = QSpinBox(self.frame_242)
        self.spin_belt_edge_margin.setObjectName(u"spin_belt_edge_margin")
        self.spin_belt_edge_margin.setMinimum(0)
        self.spin_belt_edge_margin.setMaximum(50)
        self.spin_belt_edge_margin.setValue(0)

        self.horizontalLayout_210.addWidget(self.spin_belt_edge_margin)


        self.verticalLayout_148.addWidget(self.frame_242)


        self.verticalLayout_147.addWidget(self.frame_244, 0, Qt.AlignTop)

        self.stackedWidget_4.addWidget(self.page_edge)
        self.page_threshold = QWidget()
        self.page_threshold.setObjectName(u"page_threshold")
        self.verticalLayout_146 = QVBoxLayout(self.page_threshold)
        self.verticalLayout_146.setObjectName(u"verticalLayout_146")
        self.frame_40 = QFrame(self.page_threshold)
        self.frame_40.setObjectName(u"frame_40")
        self.frame_40.setMaximumSize(QSize(16777215, 263))
        self.frame_40.setSizeIncrement(QSize(0, 263))
        self.frame_40.setFrameShape(QFrame.Panel)
        self.frame_40.setFrameShadow(QFrame.Raised)
        self.verticalLayout_32 = QVBoxLayout(self.frame_40)
        self.verticalLayout_32.setObjectName(u"verticalLayout_32")
        self.frame_221 = QFrame(self.frame_40)
        self.frame_221.setObjectName(u"frame_221")
        self.frame_221.setMinimumSize(QSize(0, 50))
        self.frame_221.setFrameShape(QFrame.Panel)
        self.frame_221.setFrameShadow(QFrame.Raised)
        self.verticalLayout_140 = QVBoxLayout(self.frame_221)
        ...
        self.frame_223.setMinimumSize(QSize(0, 25))
        self.frame_223.setMaximumSize(QSize(16777215, 25))
        self.frame_223.setFrameShape(QFrame.StyledPanel)
        self.frame_223.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_197 = QHBoxLayout(self.frame_223)
        self.horizontalLayout_197.setObjectName(u"horizontalLayout_197")
        self.horizontalLayout_197.setContentsMargins(-1, 0, -1, 0)
        self.label_168 = QLabel(self.frame_223)
        self.label_168.setObjectName(u"label_168")
        self.label_168.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_197.addWidget(self.label_168)

        self.bar_thresh_max0_1_top = QSlider(self.frame_223)
        self.bar_thresh_max0_1_top.setObjectName(u"bar_thresh_max0_1_top")
        self.bar_thresh_max0_1_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_max0_1_top.setMaximum(255)
        self.bar_thresh_max0_1_top.setValue(255)
        self.bar_thresh_max0_1_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_197.addWidget(self.bar_thresh_max0_1_top)

        self.spinBox_3 = QSpinBox(self.frame_223)
        self.spinBox_3.setObjectName(u"spinBox_3")
        self.spinBox_3.setMaximum(255)
        self.spinBox_3.setValue(255)

        self.horizontalLayout_197.addWidget(self.spinBox_3)


        self.verticalLayout_140.addWidget(self.frame_223)

        self.frame_222 = QFrame(self.frame_221)
        self.frame_222.setObjectName(u"frame_222")
        self.frame_222.setMinimumSize(QSize(0, 25))
        ...
        self.horizontalLayout_194 = QHBoxLayout(self.frame_222)
        self.horizontalLayout_194.setObjectName(u"horizontalLayout_194")
        self.horizontalLayout_194.setContentsMargins(-1, 0, -1, 0)
        self.label_54 = QLabel(self.frame_222)
        self.label_54.setObjectName(u"label_54")
        self.label_54.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_194.addWidget(self.label_54)

        self.bar_thresh_min0_1_top = QSlider(self.frame_222)
        self.bar_thresh_min0_1_top.setObjectName(u"bar_thresh_min0_1_top")
        self.bar_thresh_min0_1_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_min0_1_top.setMaximum(255)
        self.bar_thresh_min0_1_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_194.addWidget(self.bar_thresh_min0_1_top)

        self.spinBox_2 = QSpinBox(self.frame_222)
        self.spinBox_2.setObjectName(u"spinBox_2")
        self.spinBox_2.setMaximum(255)

        self.horizontalLayout_194.addWidget(self.spinBox_2)


        self.verticalLayout_140.addWidget(self.frame_222)


        self.verticalLayout_32.addWidget(self.frame_221)

        self.frame_50 = QFrame(self.frame_40)
        self.frame_50.setObjectName(u"frame_50")
        self.frame_50.setMaximumSize(QSize(16777215, 50))
        self.frame_50.setFrameShape(QFrame.Panel)
        self.frame_50.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_77 = QHBoxLayout(self.frame_50)
        self.horizontalLayout_77.setObjectName(u"horizontalLayout_77")
        self.label_9 = QLabel(self.frame_50)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_77.addWidget(self.label_9)
        ...
        self.horizontalLayout_77.addWidget(self.bar_noise_filter0_1_top)
        ...
        self.horizontalLayout_77.addWidget(self.noiseAreaSpinBox)


        self.verticalLayout_32.addWidget(self.frame_50)


        self.verticalLayout_146.addWidget(self.frame_40)

        self.stackedWidget_4.addWidget(self.page_threshold)

        self.verticalLayout_34.addWidget(self.stackedWidget_4)

        self.frame_246 = QFrame(self.frame_32)
        self.frame_246.setObjectName(u"frame_246")
        self.frame_246.setMinimumSize(QSize(0, 83))
        self.frame_246.setFrameShape(QFrame.StyledPanel)
        self.frame_246.setFrameShadow(QFrame.Raised)
        self.verticalLayout_149 = QVBoxLayout(self.frame_246)
        ...
        self.horizontalLayout_213 = QHBoxLayout(self.frame_247)
        self.horizontalLayout_213.setObjectName(u"horizontalLayout_213")
        self.label_212 = QLabel(self.frame_247)
        self.label_212.setObjectName(u"label_212")
        self.label_212.setMinimumSize(QSize(100, 0))

        self.horizontalLayout_213.addWidget(self.label_212)

        self.spin_d_parm1_1_top = QSpinBox(self.frame_247)
        self.spin_d_parm1_1_top.setObjectName(u"spin_d_parm1_1_top")
        self.spin_d_parm1_1_top.setMinimum(0)
        self.spin_d_parm1_1_top.setMaximum(10)
        self.spin_d_parm1_1_top.setValue(0)

        self.horizontalLayout_213.addWidget(self.spin_d_parm1_1_top)


        self.verticalLayout_149.addWidget(self.frame_247)
        ...
        self.horizontalLayout_214 = QHBoxLayout(self.frame_248)
        self.horizontalLayout_214.setObjectName(u"horizontalLayout_214")
        self.label_213 = QLabel(self.frame_248)
        self.label_213.setObjectName(u"label_213")
        self.label_213.setMinimumSize(QSize(100, 0))

        self.horizontalLayout_214.addWidget(self.label_213)

        self.spin_e_parm2_1_top = QSpinBox(self.frame_248)
        self.spin_e_parm2_1_top.setObjectName(u"spin_e_parm2_1_top")
        self.spin_e_parm2_1_top.setMinimum(0)
        self.spin_e_parm2_1_top.setMaximum(10)
        self.spin_e_parm2_1_top.setValue(0)

        self.horizontalLayout_214.addWidget(self.spin_e_parm2_1_top)


        self.verticalLayout_149.addWidget(self.frame_248)
        ...
        self.horizontalLayout_215 = QHBoxLayout(self.frame_249)
        self.horizontalLayout_215.setObjectName(u"horizontalLayout_215")
        self.label_214 = QLabel(self.frame_249)
        self.label_214.setObjectName(u"label_214")
        self.label_214.setMinimumSize(QSize(100, 0))

        self.horizontalLayout_215.addWidget(self.label_214)

        self.spin_d_parm3_1_top = QSpinBox(self.frame_249)
        self.spin_d_parm3_1_top.setObjectName(u"spin_d_parm3_1_top")
        self.spin_d_parm3_1_top.setMinimum(0)
        self.spin_d_parm3_1_top.setMaximum(10)
        self.spin_d_parm3_1_top.setValue(0)

        self.horizontalLayout_215.addWidget(self.spin_d_parm3_1_top)


        self.verticalLayout_149.addWidget(self.frame_249)
        ...
        self.horizontalLayout_216 = QHBoxLayout(self.frame_250)
        self.horizontalLayout_216.setObjectName(u"horizontalLayout_216")
        self.label_215 = QLabel(self.frame_250)
        self.label_215.setObjectName(u"label_215")
        self.label_215.setMinimumSize(QSize(100, 0))

        self.horizontalLayout_216.addWidget(self.label_215)

        self.spin_e_parm4_1_top = QSpinBox(self.frame_250)
        self.spin_e_parm4_1_top.setObjectName(u"spin_e_parm4_1_top")
        self.spin_e_parm4_1_top.setMinimum(0)
        self.spin_e_parm4_1_top.setMaximum(10)
        self.spin_e_parm4_1_top.setValue(0)

        self.horizontalLayout_216.addWidget(self.spin_e_parm4_1_top)


        self.verticalLayout_149.addWidget(self.frame_250)


        self.verticalLayout_34.addWidget(self.frame_246)
        ...
        self.frame_57.setMaximumSize(QSize(16777215, 52))
        self.frame_57.setFrameShape(QFrame.Box)
        self.frame_57.setFrameShadow(QFrame.Plain)
        ...
        self.btn_add_region0_2_top = QPushButton(self.frame_57)
...
"")
        icon18 = QIcon()
        icon18.addFile(u"images/plus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_add_region0_2_top.setIcon(icon18)
        self.btn_add_region0_2_top.setIconSize(QSize(26, 26))

        self.horizontalLayout_57.addWidget(self.btn_add_region0_2_top)
        ...
        self.horizontalLayout_40.addWidget(self.label_124)
        ...
        self.combo_regions_name0_2_top.setMinimumSize(QSize(190, 0))
        self.combo_regions_name0_2_top.setMaximumSize(QSize(190, 16777215))

        self.horizontalLayout_40.addWidget(self.combo_regions_name0_2_top)

        self.btn_edit_region0_2_top = QPushButton(self.frame_31)
        self.btn_edit_region0_2_top.setObjectName(u"btn_edit_region0_2_top")
        self.btn_edit_region0_2_top.setMaximumSize(QSize(26, 16777215))
        self.btn_edit_region0_2_top.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_edit_region0_2_top.setStyleSheet(u"border:none;")
        icon19 = QIcon()
        icon19.addFile(u"images/enter.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_edit_region0_2_top.setIcon(icon19)
        self.btn_edit_region0_2_top.setIconSize(QSize(26, 27))

        self.horizontalLayout_40.addWidget(self.btn_edit_region0_2_top)
        ...
        icon20 = QIcon()
        icon20.addFile(u"images/minus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_remove_region0_2_top.setIcon(icon20)
        ...
        self.frame_52.setMaximumSize(QSize(16777215, 500))
        ...
        self.frame_151.setMinimumSize(QSize(0, 29))
        self.frame_151.setMaximumSize(QSize(16777215, 12))
        self.frame_151.setFrameShape(QFrame.Panel)
        ...
        self.horizontalLayout_167.setContentsMargins(-1, 0, -1, 0)
        self.label_217 = QLabel(self.frame_151)
        self.label_217.setObjectName(u"label_217")

        self.horizontalLayout_167.addWidget(self.label_217)

        self.spin_roi_x1_2_top = QSpinBox(self.frame_151)
        self.spin_roi_x1_2_top.setObjectName(u"spin_roi_x1_2_top")
        self.spin_roi_x1_2_top.setMaximum(10000)

        self.horizontalLayout_167.addWidget(self.spin_roi_x1_2_top)

        self.label_218 = QLabel(self.frame_151)
        self.label_218.setObjectName(u"label_218")

        self.horizontalLayout_167.addWidget(self.label_218)

        self.spin_roi_y1_2_top = QSpinBox(self.frame_151)
        self.spin_roi_y1_2_top.setObjectName(u"spin_roi_y1_2_top")
        self.spin_roi_y1_2_top.setMaximum(10000)

        self.horizontalLayout_167.addWidget(self.spin_roi_y1_2_top)

        self.label_219 = QLabel(self.frame_151)
        self.label_219.setObjectName(u"label_219")

        self.horizontalLayout_167.addWidget(self.label_219)

        self.spin_roi_r1_2_top = QSpinBox(self.frame_151)
        self.spin_roi_r1_2_top.setObjectName(u"spin_roi_r1_2_top")
        self.spin_roi_r1_2_top.setMaximum(1000)

        self.horizontalLayout_167.addWidget(self.spin_roi_r1_2_top)

        self.horizontalSpacer_46 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_167.addItem(self.horizontalSpacer_46)
        ...
        self.frame_232 = QFrame(self.frame_52)
        ...
        self.horizontalLayout_201 = QHBoxLayout(self.frame_232)
        self.horizontalLayout_201.setObjectName(u"horizontalLayout_201")
        self.horizontalLayout_201.setContentsMargins(-1, 0, -1, 0)
        self.label_200 = QLabel(self.frame_232)
        self.label_200.setObjectName(u"label_200")
        self.label_200.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_201.addWidget(self.label_200)

        self.bar_thresh_max0_2_top = QSlider(self.frame_232)
        self.bar_thresh_max0_2_top.setObjectName(u"bar_thresh_max0_2_top")
        self.bar_thresh_max0_2_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_max0_2_top.setMaximum(255)
        self.bar_thresh_max0_2_top.setValue(255)
        self.bar_thresh_max0_2_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_201.addWidget(self.bar_thresh_max0_2_top)

        self.spinBox_25 = QSpinBox(self.frame_232)
        self.spinBox_25.setObjectName(u"spinBox_25")
        self.spinBox_25.setMaximum(255)
        self.spinBox_25.setValue(255)

        self.horizontalLayout_201.addWidget(self.spinBox_25)


        self.verticalLayout_42.addWidget(self.frame_232)

        self.frame_233 = QFrame(self.frame_52)
        ...
        self.horizontalLayout_195 = QHBoxLayout(self.frame_233)
        self.horizontalLayout_195.setObjectName(u"horizontalLayout_195")
        self.horizontalLayout_195.setContentsMargins(-1, 0, -1, 0)
        self.label_201 = QLabel(self.frame_233)
        self.label_201.setObjectName(u"label_201")
        self.label_201.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_195.addWidget(self.label_201)

        self.bar_thresh_min0_2_top = QSlider(self.frame_233)
        self.bar_thresh_min0_2_top.setObjectName(u"bar_thresh_min0_2_top")
        self.bar_thresh_min0_2_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_min0_2_top.setMaximum(255)
        self.bar_thresh_min0_2_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_195.addWidget(self.bar_thresh_min0_2_top)

        self.spinBox_26 = QSpinBox(self.frame_233)
        self.spinBox_26.setObjectName(u"spinBox_26")
        self.spinBox_26.setMaximum(255)

        self.horizontalLayout_195.addWidget(self.spinBox_26)


        self.verticalLayout_42.addWidget(self.frame_233)
        ...
        self.stackedWidget_3.setMinimumSize(QSize(0, 168))
        self.stackedWidget_3.setMaximumSize(QSize(16777215, 168))
        ...
        self.verticalLayout_41.setContentsMargins(-1, 9, -1, -1)
        ...
        self.btn_draw_complete0_2_top.setEnabled(True)
...
"}")
        ...
        self.page_3_top.setMaximumSize(QSize(16777215, 566))
        ...
        self.frame_166.setFrameShape(QFrame.Box)
        self.frame_166.setFrameShadow(QFrame.Plain)
        ...
        self.btn_add_region0_3_top = QPushButton(self.frame_166)
...
"")
        self.btn_add_region0_3_top.setIcon(icon18)
        self.btn_add_region0_3_top.setIconSize(QSize(26, 26))

        self.horizontalLayout_80.addWidget(self.btn_add_region0_3_top)


        self.verticalLayout_111.addWidget(self.frame_166, 0, Qt.AlignTop)
        ...
        self.label_203 = QLabel(self.frame_55)
        ...
        self.combo_regions_name0_3_top.setMinimumSize(QSize(190, 0))
        self.combo_regions_name0_3_top.setMaximumSize(QSize(190, 16777215))

        self.horizontalLayout_56.addWidget(self.combo_regions_name0_3_top)

        self.btn_remove_region0_3_top_2 = QPushButton(self.frame_55)
        self.btn_remove_region0_3_top_2.setObjectName(u"btn_remove_region0_3_top_2")
        self.btn_remove_region0_3_top_2.setMaximumSize(QSize(26, 16777215))
        self.btn_remove_region0_3_top_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_remove_region0_3_top_2.setStyleSheet(u"border:none;")
        self.btn_remove_region0_3_top_2.setIcon(icon19)
        self.btn_remove_region0_3_top_2.setIconSize(QSize(26, 27))

        self.horizontalLayout_56.addWidget(self.btn_remove_region0_3_top_2)
        ...
        self.frame_193.setMinimumSize(QSize(0, 455))
        self.frame_193.setMaximumSize(QSize(16777215, 455))
        ...
        self.verticalLayout_130.setContentsMargins(-1, 0, -1, 0)
        self.groupBox_8 = QGroupBox(self.frame_193)
        self.groupBox_8.setObjectName(u"groupBox_8")
        self.groupBox_8.setMinimumSize(QSize(0, 55))
        self.groupBox_8.setMaximumSize(QSize(16777215, 55))
        ...
        self.frame_56.setMinimumSize(QSize(0, 29))
        self.frame_56.setMaximumSize(QSize(16777215, 12))
        self.frame_56.setFrameShape(QFrame.Panel)
        ...
        self.spin_roi_x1_3_top.setMaximum(10000)
        ...
        self.spin_roi_y1_3_top.setMaximum(10000)
        ...
        self.spin_roi_r1_3_top.setMaximum(1000)
        ...
        self.groupBox_9.setMinimumSize(QSize(0, 55))
        self.groupBox_9.setMaximumSize(QSize(16777215, 55))
        ...
        self.frame_171.setFrameShape(QFrame.Panel)
        ...
        self.spin_roi_x2_3_top.setMaximum(10000)
        ...
        self.spin_roi_y2_3_top.setMaximum(10000)
        ...
        self.spin_roi_r2_3_top.setMaximum(1000)
        ...
        self.frame_169.setMinimumSize(QSize(0, 25))
        self.frame_169.setMaximumSize(QSize(16777215, 25))
        ...
        self.frame_170.setMinimumSize(QSize(0, 25))
        self.frame_170.setMaximumSize(QSize(16777215, 25))
        ...
        self.label_138 = QLabel(self.frame_170)
        self.label_138.setObjectName(u"label_138")
        self.label_138.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_174.addWidget(self.label_138)

        self.bar_thresh_max0_3_top = QSlider(self.frame_170)
        self.bar_thresh_max0_3_top.setObjectName(u"bar_thresh_max0_3_top")
        self.bar_thresh_max0_3_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_max0_3_top.setMaximum(255)
        self.bar_thresh_max0_3_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_174.addWidget(self.bar_thresh_max0_3_top)
        ...
        self.frame_251 = QFrame(self.frame_193)
        self.frame_251.setObjectName(u"frame_251")
        self.frame_251.setMinimumSize(QSize(0, 25))
        self.frame_251.setMaximumSize(QSize(16777215, 25))
        self.frame_251.setFrameShape(QFrame.StyledPanel)
        self.frame_251.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_217 = QHBoxLayout(self.frame_251)
        self.horizontalLayout_217.setObjectName(u"horizontalLayout_217")
        self.horizontalLayout_217.setContentsMargins(0, 0, -1, 0)
        self.label_216 = QLabel(self.frame_251)
        self.label_216.setObjectName(u"label_216")
        self.label_216.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_217.addWidget(self.label_216)

        self.bar_thresh_min0_3_top = QSlider(self.frame_251)
        self.bar_thresh_min0_3_top.setObjectName(u"bar_thresh_min0_3_top")
        self.bar_thresh_min0_3_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_min0_3_top.setMaximum(255)
        self.bar_thresh_min0_3_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_217.addWidget(self.bar_thresh_min0_3_top)

        self.spinBox_12 = QSpinBox(self.frame_251)
        self.spinBox_12.setObjectName(u"spinBox_12")
        self.spinBox_12.setEnabled(True)
        self.spinBox_12.setMaximum(255)

        self.horizontalLayout_217.addWidget(self.spinBox_12)


        self.verticalLayout_130.addWidget(self.frame_251)

        self.frame_167 = QFrame(self.frame_193)
        self.frame_167.setObjectName(u"frame_167")
        self.frame_167.setEnabled(True)
        self.frame_167.setMaximumSize(QSize(16777215, 40))
        self.frame_167.setFrameShape(QFrame.Panel)
        ...
        self.label_137 = QLabel(self.frame_168)
        self.label_137.setObjectName(u"label_137")
        self.label_137.setEnabled(True)
        self.label_137.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_170.addWidget(self.label_137)
        ...
        self.frame_192.setFrameShape(QFrame.Panel)
        ...
        self.groupBox_18.setMinimumSize(QSize(0, 55))
        self.groupBox_18.setMaximumSize(QSize(16777215, 55))
        ...
        self.verticalLayout_130.addItem(self.verticalSpacer_22)
        ...
        self.verticalLayout_111.addItem(self.verticalSpacer_21)
        ...
        self.frame_252 = QFrame(self.frame_194)
        ...
        self.verticalLayout_150 = QVBoxLayout(self.frame_252)
        ...
        self.frame_253.setMinimumSize(QSize(0, 25))
        self.frame_253.setMaximumSize(QSize(16777215, 25))
        self.frame_253.setFrameShape(QFrame.NoFrame)
        self.frame_253.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_218 = QHBoxLayout(self.frame_253)
        self.horizontalLayout_218.setObjectName(u"horizontalLayout_218")
        self.horizontalLayout_218.setContentsMargins(0, 0, -1, 0)
        self.label_220 = QLabel(self.frame_253)
        self.label_220.setObjectName(u"label_220")
        self.label_220.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_218.addWidget(self.label_220)

        self.bar_thresh_max0_4_top = QSlider(self.frame_253)
        self.bar_thresh_max0_4_top.setObjectName(u"bar_thresh_max0_4_top")
        self.bar_thresh_max0_4_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_max0_4_top.setMaximum(255)
        self.bar_thresh_max0_4_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_218.addWidget(self.bar_thresh_max0_4_top)

        self.spinBox_28 = QSpinBox(self.frame_253)
        self.spinBox_28.setObjectName(u"spinBox_28")
        self.spinBox_28.setEnabled(True)
        self.spinBox_28.setMaximum(255)

        self.horizontalLayout_218.addWidget(self.spinBox_28)


        self.verticalLayout_150.addWidget(self.frame_253)

        self.frame_254 = QFrame(self.frame_252)
        ...
        self.verticalLayout_151 = QVBoxLayout(self.frame_254)
        self.verticalLayout_151.setObjectName(u"verticalLayout_151")
        self.verticalLayout_151.setContentsMargins(0, -1, 0, -1)
        self.frame_255 = QFrame(self.frame_254)
        self.frame_255.setObjectName(u"frame_255")
        self.frame_255.setMinimumSize(QSize(0, 25))
        self.frame_255.setMaximumSize(QSize(16777215, 25))
        self.frame_255.setFrameShape(QFrame.NoFrame)
        self.frame_255.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_219 = QHBoxLayout(self.frame_255)
        self.horizontalLayout_219.setObjectName(u"horizontalLayout_219")
        self.horizontalLayout_219.setContentsMargins(0, 0, -1, 0)
        self.label_221 = QLabel(self.frame_255)
        self.label_221.setObjectName(u"label_221")
        self.label_221.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_219.addWidget(self.label_221)

        self.bar_thresh_min0_4_top = QSlider(self.frame_255)
        self.bar_thresh_min0_4_top.setObjectName(u"bar_thresh_min0_4_top")
        self.bar_thresh_min0_4_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_min0_4_top.setMaximum(255)
        self.bar_thresh_min0_4_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_219.addWidget(self.bar_thresh_min0_4_top)

        self.spinBox_29 = QSpinBox(self.frame_255)
        self.spinBox_29.setObjectName(u"spinBox_29")
        self.spinBox_29.setEnabled(True)
        self.spinBox_29.setMaximum(255)

        self.horizontalLayout_219.addWidget(self.spinBox_29)


        self.verticalLayout_151.addWidget(self.frame_255)


        self.verticalLayout_150.addWidget(self.frame_254)


        self.verticalLayout_121.addWidget(self.frame_252)
        ...
        self.frame_207.setFrameShape(QFrame.Panel)
        ...
        self.frame_256 = QFrame(self.frame_172)
        ...
        self.verticalLayout_152 = QVBoxLayout(self.frame_256)
        ...
        self.frame_257.setMinimumSize(QSize(0, 25))
        self.frame_257.setMaximumSize(QSize(16777215, 25))
        self.frame_257.setFrameShape(QFrame.NoFrame)
        self.frame_257.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_220 = QHBoxLayout(self.frame_257)
        self.horizontalLayout_220.setObjectName(u"horizontalLayout_220")
        self.horizontalLayout_220.setContentsMargins(0, 0, -1, 0)
        self.label_223 = QLabel(self.frame_257)
        self.label_223.setObjectName(u"label_223")
        self.label_223.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_220.addWidget(self.label_223)

        self.bar_thresh_max0_5_top = QSlider(self.frame_257)
        self.bar_thresh_max0_5_top.setObjectName(u"bar_thresh_max0_5_top")
        self.bar_thresh_max0_5_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_max0_5_top.setMaximum(255)
        self.bar_thresh_max0_5_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_220.addWidget(self.bar_thresh_max0_5_top)

        self.spinBox_30 = QSpinBox(self.frame_257)
        self.spinBox_30.setObjectName(u"spinBox_30")
        self.spinBox_30.setEnabled(True)
        self.spinBox_30.setMaximum(255)

        self.horizontalLayout_220.addWidget(self.spinBox_30)


        self.verticalLayout_152.addWidget(self.frame_257)
        ...
        self.verticalLayout_153 = QVBoxLayout(self.frame_258)
        self.verticalLayout_153.setObjectName(u"verticalLayout_153")
        self.verticalLayout_153.setContentsMargins(0, -1, 0, -1)
        self.frame_259 = QFrame(self.frame_258)
        self.frame_259.setObjectName(u"frame_259")
        self.frame_259.setMinimumSize(QSize(0, 25))
        self.frame_259.setMaximumSize(QSize(16777215, 25))
        self.frame_259.setFrameShape(QFrame.NoFrame)
        self.frame_259.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_221 = QHBoxLayout(self.frame_259)
        self.horizontalLayout_221.setObjectName(u"horizontalLayout_221")
        self.horizontalLayout_221.setContentsMargins(0, 0, -1, 0)
        self.label_224 = QLabel(self.frame_259)
        self.label_224.setObjectName(u"label_224")
        self.label_224.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_221.addWidget(self.label_224)

        self.bar_thresh_min0_5_top = QSlider(self.frame_259)
        self.bar_thresh_min0_5_top.setObjectName(u"bar_thresh_min0_5_top")
        self.bar_thresh_min0_5_top.setMinimumSize(QSize(0, 30))
        self.bar_thresh_min0_5_top.setMaximum(255)
        self.bar_thresh_min0_5_top.setOrientation(Qt.Horizontal)

        self.horizontalLayout_221.addWidget(self.bar_thresh_min0_5_top)

        self.spinBox_31 = QSpinBox(self.frame_259)
        self.spinBox_31.setObjectName(u"spinBox_31")
        self.spinBox_31.setEnabled(True)
        self.spinBox_31.setMaximum(255)

        self.horizontalLayout_221.addWidget(self.spinBox_31)


        self.verticalLayout_153.addWidget(self.frame_259)


        self.verticalLayout_152.addWidget(self.frame_258)


        self.verticalLayout_135.addWidget(self.frame_256)
        ...
        self.frame_216.setFrameShape(QFrame.Panel)
        ...
        self.label_184 = QLabel(self.frame_217)
        ...
        self.frame_213.setFrameShape(QFrame.Panel)
        ...
        self.frame_218.setFrameShape(QFrame.Box)
        ...
        self.frame_61.setFrameShape(QFrame.Panel)
        ...
        self.frame_226 = QFrame(self.frame_58)
        self.frame_226.setObjectName(u"frame_226")
        self.frame_226.setMinimumSize(QSize(0, 43))
        self.frame_226.setFrameShape(QFrame.StyledPanel)
        self.frame_226.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_199 = QHBoxLayout(self.frame_226)
        self.horizontalLayout_199.setObjectName(u"horizontalLayout_199")
        self.horizontalLayout_199.setContentsMargins(0, 0, -1, 0)
        self.label_197 = QLabel(self.frame_226)
        self.label_197.setObjectName(u"label_197")
        self.label_197.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_199.addWidget(self.label_197)

        self.bar_thresh_max0_1_side = QSlider(self.frame_226)
        self.bar_thresh_max0_1_side.setObjectName(u"bar_thresh_max0_1_side")
        self.bar_thresh_max0_1_side.setMinimumSize(QSize(0, 30))
        self.bar_thresh_max0_1_side.setMaximum(255)
        self.bar_thresh_max0_1_side.setValue(255)
        self.bar_thresh_max0_1_side.setOrientation(Qt.Horizontal)

        self.horizontalLayout_199.addWidget(self.bar_thresh_max0_1_side)

        self.spinBox_24 = QSpinBox(self.frame_226)
        self.spinBox_24.setObjectName(u"spinBox_24")
        self.spinBox_24.setEnabled(True)
        self.spinBox_24.setMaximum(255)
        self.spinBox_24.setValue(255)

        self.horizontalLayout_199.addWidget(self.spinBox_24)


        self.verticalLayout_35.addWidget(self.frame_226)

        self.frame_224 = QFrame(self.frame_58)
        self.frame_224.setObjectName(u"frame_224")
        self.frame_224.setEnabled(True)
        self.frame_224.setMinimumSize(QSize(0, 66))
        self.frame_224.setMaximumSize(QSize(16777215, 67))
        self.frame_224.setFrameShape(QFrame.Panel)
        self.frame_224.setFrameShadow(QFrame.Raised)
        self.verticalLayout_141 = QVBoxLayout(self.frame_224)
        ...
        self.frame_225.setMinimumSize(QSize(0, 43))
        self.frame_225.setFrameShape(QFrame.StyledPanel)
        self.frame_225.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_198 = QHBoxLayout(self.frame_225)
        self.horizontalLayout_198.setObjectName(u"horizontalLayout_198")
        self.horizontalLayout_198.setContentsMargins(0, 0, -1, 0)
        self.label_188 = QLabel(self.frame_225)
        self.label_188.setObjectName(u"label_188")
        self.label_188.setMaximumSize(QSize(16777215, 50))

        self.horizontalLayout_198.addWidget(self.label_188)

        self.bar_thresh_min0_1_side = QSlider(self.frame_225)
        self.bar_thresh_min0_1_side.setObjectName(u"bar_thresh_min0_1_side")
        self.bar_thresh_min0_1_side.setMinimumSize(QSize(0, 30))
        self.bar_thresh_min0_1_side.setMaximum(255)
        self.bar_thresh_min0_1_side.setOrientation(Qt.Horizontal)

        self.horizontalLayout_198.addWidget(self.bar_thresh_min0_1_side)

        self.spinBox_23 = QSpinBox(self.frame_225)
        self.spinBox_23.setObjectName(u"spinBox_23")
        self.spinBox_23.setEnabled(True)
        self.spinBox_23.setMaximum(255)

        self.horizontalLayout_198.addWidget(self.spinBox_23)


        self.verticalLayout_141.addWidget(self.frame_225)


        self.verticalLayout_35.addWidget(self.frame_224)

        self.frame_63 = QFrame(self.frame_58)
        self.frame_63.setObjectName(u"frame_63")
        self.frame_63.setEnabled(True)
        self.frame_63.setMaximumSize(QSize(16777215, 72))
        self.frame_63.setFrameShape(QFrame.Panel)
        ...
        self.frame_224.raise_()
        self.frame_226.raise_()
        ...
        self.frame_140.setFrameShape(QFrame.Panel)
        ...
        self.frame_195 = QFrame(self.page_3_side)
        self.frame_195.setObjectName(u"frame_195")
        self.frame_195.setFrameShape(QFrame.Box)
        self.frame_195.setFrameShadow(QFrame.Raised)
        self.frame_195.setLineWidth(2)
        self.horizontalLayout_186 = QHBoxLayout(self.frame_195)
        self.horizontalLayout_186.setObjectName(u"horizontalLayout_186")
        self.label_126 = QLabel(self.frame_195)
        self.label_126.setObjectName(u"label_126")

        self.horizontalLayout_186.addWidget(self.label_126)

        self.label_navel_3_side = QLabel(self.frame_195)
        self.label_navel_3_side.setObjectName(u"label_navel_3_side")

        self.horizontalLayout_186.addWidget(self.label_navel_3_side)
        ...
        self.spin_min_navel_3_side = QSpinBox(self.frame_195)
        self.spin_min_navel_3_side.setObjectName(u"spin_min_navel_3_side")
        self.spin_min_navel_3_side.setMaximumSize(QSize(50, 16777215))
        self.spin_min_navel_3_side.setMaximum(20000)
        self.spin_min_navel_3_side.setSingleStep(5)

        self.horizontalLayout_186.addWidget(self.spin_min_navel_3_side)

        self.label_222 = QLabel(self.frame_195)
        self.label_222.setObjectName(u"label_222")

        self.horizontalLayout_186.addWidget(self.label_222)

        self.spin_max_navel_3_side = QSpinBox(self.frame_195)
        self.spin_max_navel_3_side.setObjectName(u"spin_max_navel_3_side")
        self.spin_max_navel_3_side.setMaximumSize(QSize(50, 16777215))
        self.spin_max_navel_3_side.setMaximum(20000)
        self.spin_max_navel_3_side.setSingleStep(5)

        self.horizontalLayout_186.addWidget(self.spin_max_navel_3_side)


        self.verticalLayout_63.addWidget(self.frame_195)
        ...
        self.frame_114.setFrameShape(QFrame.Box)
        ...
        self.frame_142.setFrameShape(QFrame.Panel)
...
"")
        self.btn_add_region0_4_side.setIcon(icon18)
        ...
        self.btn_remove_region0_4_side.setIcon(icon20)
        ...
        self.frame_141.setFrameShape(QFrame.Box)
        ...
        self.frame_145.setFrameShape(QFrame.Panel)
        ...
        self.frame_136.setFrameShape(QFrame.Panel)
        ...
        self.check_top_5_side = QRadioButton(self.frame_65)
        self.check_top_5_side.setObjectName(u"check_top_5_side")

        self.horizontalLayout_71.addWidget(self.check_top_5_side)

        self.check_bottom_5_side = QRadioButton(self.frame_65)
        self.check_bottom_5_side.setObjectName(u"check_bottom_5_side")

        self.horizontalLayout_71.addWidget(self.check_bottom_5_side)
        ...
        self.frame_149.setFrameShape(QFrame.Box)
        ...
        self.frame_146.setFrameShape(QFrame.Box)
        ...
        self.frame_138.setFrameShape(QFrame.Box)
        ...
        self.frame_76.setFrameShape(QFrame.Box)
        ...
        self.frame_122.setFrameShape(QFrame.Box)
        ...
        self.frame_144.setFrameShape(QFrame.Box)
...
"")
        self.btn_add_region0_6_side.setIcon(icon18)
        ...
        self.btn_remove_region0_6_side.setIcon(icon20)
        ...
        self.stackedWidget_2.addWidget(self.page_none)
...
"}")
        icon21 = QIcon()
        icon21.addFile(u"images/prev.png", QSize(), QIcon.Normal, QIcon.Off)
        self.prev_page_btn.setIcon(icon21)
...
"}")
        icon22 = QIcon()
        icon22.addFile(u"images/next.png", QSize(), QIcon.Normal, QIcon.Off)
        self.next_page_btn.setIcon(icon22)
        ...
        self.label_image_grab_page.setMinimumSize(QSize(300, 300))
        self.label_image_grab_page.setMaximumSize(QSize(300, 300))
        self.label_image_grab_page.setScaledContents(True)

        self.verticalLayout_40.addWidget(self.label_image_grab_page, 0, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.frame_77.setMaximumSize(QSize(220, 50))
        ...
        self.btn_tools_live = QPushButton(self.frame_39)
        self.btn_tools_live.setObjectName(u"btn_tools_live")
        self.btn_tools_live.setMinimumSize(QSize(37, 27))
        self.btn_tools_live.setMaximumSize(QSize(16777215, 27))
        self.btn_tools_live.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout_42.addWidget(self.btn_tools_live)
...
"border-color:Transparent")
        icon23 = QIcon()
        icon23.addFile(u"../../.designer/backup/images/camtop.png", QSize(), QIcon.Normal, QIcon.Off)
        self.camera01_btn.setIcon(icon23)
...
"border-color:Transparent")
        icon24 = QIcon()
        icon24.addFile(u"../../.designer/backup/images/camside.png", QSize(), QIcon.Normal, QIcon.Off)
        self.camera02_btn.setIcon(icon24)
        ...
        self.cameraname_label.setFont(font6)
...
"}")
        ...
        self.frame_22812 = QFrame(self.frame_6)
        self.frame_22812.setObjectName(u"frame_22812")
        self.frame_22812.setMinimumSize(QSize(0, 0))
        self.frame_22812.setMaximumSize(QSize(16777215, 500))
        self.frame_22812.setFrameShape(QFrame.StyledPanel)
        self.frame_22812.setFrameShadow(QFrame.Raised)
        self.verticalLayout_143 = QVBoxLayout(self.frame_22812)
        self.verticalLayout_143.setObjectName(u"verticalLayout_143")
        self.verticalLayout_143.setContentsMargins(1, 1, 1, 1)
        self.scrollArea_2 = QScrollArea(self.frame_22812)
        self.scrollArea_2.setObjectName(u"scrollArea_2")
        self.scrollArea_2.setMinimumSize(QSize(0, 236))
        self.scrollArea_2.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 251, 509))
        self.verticalLayout_142 = QVBoxLayout(self.scrollAreaWidgetContents)
        self.verticalLayout_142.setSpacing(6)
        self.verticalLayout_142.setObjectName(u"verticalLayout_142")
        self.verticalLayout_142.setContentsMargins(0, 0, 0, -1)
        ...
        self.gridLayout.addWidget(self.expo_spinbox, 1, 1, 1, 1)
        ...
        self.packetsize_spinbox.setMaximum(36000)
        self.packetsize_spinbox.setSingleStep(1)

        self.gridLayout.addWidget(self.packetsize_spinbox, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.expo_label, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.height_label, 4, 0, 1, 1)
        ...
        self.maxbuffer_spinbox.setMaximum(36000)
        self.maxbuffer_spinbox.setSingleStep(1)

        self.gridLayout.addWidget(self.maxbuffer_spinbox, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.trigger_combo, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.offsety_label, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.gain_label_2, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.gain_spinbox, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.offsetx_spinbox, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.height_spinbox, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.width_label, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.offsety_spinbox, 6, 1, 1, 1)
        ...
        self.packetdelay_spinbox.setMaximum(36000)
        self.packetdelay_spinbox.setSingleStep(1)

        self.gridLayout.addWidget(self.packetdelay_spinbox, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.width_spinbox, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.packetdelay_label, 9, 0, 1, 1)
        ...
        self.transmissiondelay_spinbox.setMaximum(36000)
        self.transmissiondelay_spinbox.setSingleStep(1)

        self.gridLayout.addWidget(self.transmissiondelay_spinbox, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.transmissiondelay_label, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.maxbuffer_label, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.offsetx_label, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.serial_number_combo, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.packetsize_label, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.transmissiondelay_label_2, 12, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.ip_lineedit, 12, 1, 1, 1)


        self.verticalLayout_142.addWidget(self.frame_10)

        self.scrollArea_2.setWidget(self.scrollAreaWidgetContents)

        self.verticalLayout_143.addWidget(self.scrollArea_2)

        self.frame_160 = QFrame(self.frame_22812)
...
"}")
        ...
        self.verticalLayout_143.addWidget(self.frame_160)


        self.verticalLayout_24.addWidget(self.frame_22812)
...
"background-color: rgb(0, 170, 0);")
        icon25 = QIcon()
        icon25.addFile(u"images/icons/cil-media-play.png", QSize(), QIcon.Normal, QIcon.Off)
        self.play_camera_setting_btn.setIcon(icon25)
        ...
        icon26 = QIcon()
        icon26.addFile(u"images/icons/cil-media-pause.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pause_camera_setting_btn.setIcon(icon26)
...
"background-color: rgb(153, 193, 241);")
        ...
        font7.setBold(True)
        self.camera_setting_message_label.setFont(font7)
        ...
        self.camera_setting_picture_top.setMinimumSize(QSize(500, 500))
        ...
        self.camera_setting_picture_top.setScaledContents(False)
        ...
        self.frame_219 = QFrame(self.frame_209)
        self.frame_219.setObjectName(u"frame_219")
        self.frame_219.setMaximumSize(QSize(16777215, 34))
        self.frame_219.setFrameShape(QFrame.StyledPanel)
        self.frame_219.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_202 = QHBoxLayout(self.frame_219)
        self.horizontalLayout_202.setObjectName(u"horizontalLayout_202")
        self.horizontalLayout_202.setContentsMargins(-1, 0, -1, 0)
        self.camera_setting_get_top_camera = QPushButton(self.frame_219)
        ...
        self.camera_setting_get_top_camera.setMinimumSize(QSize(110, 30))
        self.camera_setting_get_top_camera.setMaximumSize(QSize(110, 30))
...
"}")
        icon27 = QIcon()
        icon27.addFile(u"images/camera.png", QSize(), QIcon.Normal, QIcon.Off)
        self.camera_setting_get_top_camera.setIcon(icon27)

        self.horizontalLayout_202.addWidget(self.camera_setting_get_top_camera)

        self.camera_setting_full_screen_top_camera = QPushButton(self.frame_219)
        self.camera_setting_full_screen_top_camera.setObjectName(u"camera_setting_full_screen_top_camera")
        self.camera_setting_full_screen_top_camera.setEnabled(True)
        self.camera_setting_full_screen_top_camera.setMinimumSize(QSize(110, 30))
        self.camera_setting_full_screen_top_camera.setMaximumSize(QSize(110, 30))
        self.camera_setting_full_screen_top_camera.setCursor(QCursor(Qt.PointingHandCursor))
        self.camera_setting_full_screen_top_camera.setStyleSheet(u"QPushButton{\n"
"background: #78AD40;\n"
"border: Transparent;\n"
"}\n"
"\n"
...
"}")
        icon28 = QIcon()
        icon28.addFile(u"images/full-screen.png", QSize(), QIcon.Normal, QIcon.Off)
        self.camera_setting_full_screen_top_camera.setIcon(icon28)

        self.horizontalLayout_202.addWidget(self.camera_setting_full_screen_top_camera)


        self.verticalLayout_110.addWidget(self.frame_219)
        ...
        icon29 = QIcon()
        icon29.addFile(u"../../.designer/backup/images/full-screen.png", QSize(), QIcon.Normal, QIcon.Off)
        self.fullscreen_cam_top_btn.setIcon(icon29)
        ...
        self.camera_setting_picture_side.setMinimumSize(QSize(500, 500))
        ...
        self.camera_setting_picture_side.setScaledContents(False)
        ...
        self.frame_234 = QFrame(self.frame_210)
        self.frame_234.setObjectName(u"frame_234")
        self.frame_234.setMaximumSize(QSize(16777215, 34))
        self.frame_234.setFrameShape(QFrame.StyledPanel)
        self.frame_234.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_203 = QHBoxLayout(self.frame_234)
        self.horizontalLayout_203.setObjectName(u"horizontalLayout_203")
        self.horizontalLayout_203.setContentsMargins(-1, 0, -1, 0)
        self.camera_setting_get_side_camera = QPushButton(self.frame_234)
        ...
        self.camera_setting_get_side_camera.setMinimumSize(QSize(110, 30))
        self.camera_setting_get_side_camera.setMaximumSize(QSize(110, 30))
...
"	background-color: rgb(0, 0, 0);\n"
"}")
        self.camera_setting_get_side_camera.setIcon(icon27)

        self.horizontalLayout_203.addWidget(self.camera_setting_get_side_camera)

        self.camera_setting_full_screen_side_camera = QPushButton(self.frame_234)
        self.camera_setting_full_screen_side_camera.setObjectName(u"camera_setting_full_screen_side_camera")
        self.camera_setting_full_screen_side_camera.setEnabled(True)
        self.camera_setting_full_screen_side_camera.setMinimumSize(QSize(110, 30))
        self.camera_setting_full_screen_side_camera.setMaximumSize(QSize(110, 30))
        self.camera_setting_full_screen_side_camera.setCursor(QCursor(Qt.PointingHandCursor))
        self.camera_setting_full_screen_side_camera.setStyleSheet(u"QPushButton{\n"
"background: #78AD40;\n"
"border: Transparent;\n"
"}\n"
"\n"
...
"	background-color: rgb(0, 0, 0);\n"
"}")
        self.camera_setting_full_screen_side_camera.setIcon(icon28)

        self.horizontalLayout_203.addWidget(self.camera_setting_full_screen_side_camera)


        self.verticalLayout_131.addWidget(self.frame_234)
        ...
        self.fullscreen_cam_side_btn.setIcon(icon29)
        ...
        self.camera_setting_tools_page.setMinimumSize(QSize(120, 30))
        self.camera_setting_tools_page.setMaximumSize(QSize(146, 30))
...
"}")
        ...
        self.camerasetting_back_tools_btn_frame = QFrame(self.frame_7)
        self.camerasetting_back_tools_btn_frame.setObjectName(u"camerasetting_back_tools_btn_frame")
        self.horizontalLayout_100 = QHBoxLayout(self.camerasetting_back_tools_btn_frame)
        self.horizontalLayout_100.setObjectName(u"horizontalLayout_100")

        self.verticalLayout_18.addWidget(self.camerasetting_back_tools_btn_frame)
...
"	border: 2px solid rgb(61, 70, 86);\n"
"}")
        self.btn_connect_top_cal_page.setIcon(icon17)
...
"	border: 2px solid rgb(61, 70, 86);\n"
"}")
        self.btn_disconnect_top_cal_page.setIcon(icon16)
        ...
        self.frame_240 = QFrame(self.frame_181)
        self.frame_240.setObjectName(u"frame_240")
        self.frame_240.setMaximumSize(QSize(16777215, 50))
        self.frame_240.setFrameShape(QFrame.StyledPanel)
        self.frame_240.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_208 = QHBoxLayout(self.frame_240)
        self.horizontalLayout_208.setObjectName(u"horizontalLayout_208")
        self.horizontalLayout_208.setContentsMargins(0, 0, 0, 0)
        self.label_208 = QLabel(self.frame_240)
        self.label_208.setObjectName(u"label_208")

        self.horizontalLayout_208.addWidget(self.label_208)

        self.doubleSpinBox_calibration_top = QDoubleSpinBox(self.frame_240)
        self.doubleSpinBox_calibration_top.setObjectName(u"doubleSpinBox_calibration_top")
        self.doubleSpinBox_calibration_top.setMaximumSize(QSize(100, 16777215))

        self.horizontalLayout_208.addWidget(self.doubleSpinBox_calibration_top)

        self.label_210 = QLabel(self.frame_240)
        self.label_210.setObjectName(u"label_210")
        self.label_210.setMaximumSize(QSize(20, 16777215))

        self.horizontalLayout_208.addWidget(self.label_210)

        self.btn_save_value_top_cal_page = QPushButton(self.frame_240)
        self.btn_save_value_top_cal_page.setObjectName(u"btn_save_value_top_cal_page")
        self.btn_save_value_top_cal_page.setMinimumSize(QSize(0, 25))
        self.btn_save_value_top_cal_page.setMaximumSize(QSize(40, 16777215))
        ...
        icon30 = QIcon()
        icon30.addFile(u"images/icons/cil-save.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_save_value_top_cal_page.setIcon(icon30)

        self.horizontalLayout_208.addWidget(self.btn_save_value_top_cal_page)


        self.verticalLayout_52.addWidget(self.frame_240)
        ...
        self.frame_155.setEnabled(False)
        ...
        self.frame_187.setEnabled(False)
        ...
        self.frame_158.setEnabled(False)
        ...
        self.label_173.setEnabled(False)
        ...
        self.frame_196.setEnabled(False)
...
"	border: 2px solid rgb(61, 70, 86);\n"
"}")
        self.btn_connect_side_cal_page.setIcon(icon17)
...
"	border: 2px solid rgb(61, 70, 86);\n"
"}")
        self.btn_disconnect_side_cal_page.setIcon(icon16)
        ...
        self.frame_241 = QFrame(self.frame_198)
        self.frame_241.setObjectName(u"frame_241")
        self.frame_241.setMaximumSize(QSize(16777215, 50))
        self.frame_241.setFrameShape(QFrame.StyledPanel)
        self.frame_241.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_209 = QHBoxLayout(self.frame_241)
        self.horizontalLayout_209.setObjectName(u"horizontalLayout_209")
        self.horizontalLayout_209.setContentsMargins(0, 0, 0, 0)
        self.label_209 = QLabel(self.frame_241)
        self.label_209.setObjectName(u"label_209")

        self.horizontalLayout_209.addWidget(self.label_209)

        self.doubleSpinBox_calibration_side = QDoubleSpinBox(self.frame_241)
        self.doubleSpinBox_calibration_side.setObjectName(u"doubleSpinBox_calibration_side")
        self.doubleSpinBox_calibration_side.setMaximumSize(QSize(100, 16777215))

        self.horizontalLayout_209.addWidget(self.doubleSpinBox_calibration_side)

        self.label_211 = QLabel(self.frame_241)
        self.label_211.setObjectName(u"label_211")
        self.label_211.setMaximumSize(QSize(20, 16777215))

        self.horizontalLayout_209.addWidget(self.label_211)

        self.btn_save_value_side_cal_page = QPushButton(self.frame_241)
        self.btn_save_value_side_cal_page.setObjectName(u"btn_save_value_side_cal_page")
        self.btn_save_value_side_cal_page.setMinimumSize(QSize(0, 25))
        self.btn_save_value_side_cal_page.setMaximumSize(QSize(40, 16777215))
        ...
        self.btn_save_value_side_cal_page.setIcon(icon30)

        self.horizontalLayout_209.addWidget(self.btn_save_value_side_cal_page)


        self.verticalLayout_122.addWidget(self.frame_241)
        ...
        self.frame_201.setEnabled(False)
        ...
        self.frame_202.setEnabled(False)
        ...
        self.frame_204.setEnabled(False)
        ...
        self.frame_206.setEnabled(False)
...
"")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 276, 834))
...
"}")
        ...
        font8.setBold(False)
        self.create_user.setFont(font8)
...
"}")
        ...
        self.verticalLayout_75.setContentsMargins(10, 0, 10, 0)
...
"}")
        ...
        self.general_setting_appearance_message_label.setFont(font7)
...
"}")
        ...
        self.setting_defect_message_label.setFont(font9)
        ...
        self.frame_174.setMinimumSize(QSize(0, 48))
        self.frame_174.setMaximumSize(QSize(16777215, 900))
        self.frame_174.setFrameShape(QFrame.Box)
        ...
        self.btn_save_ip_plc.setIcon(icon15)
        ...
        self.frame_173.setMinimumSize(QSize(0, 48))
        self.frame_173.setFrameShape(QFrame.Box)
...
"}")
        ...
        self.groupBox_13.setMaximumSize(QSize(16777215, 558))
        ...
        self.line_run = QLineEdit(self.frame_177)
        self.line_run.setObjectName(u"line_run")
        self.line_run.setMaximumSize(QSize(300, 30))

        self.horizontalLayout_95.addWidget(self.line_run)

        self.label_run = QLabel(self.frame_177)
        self.label_run.setObjectName(u"label_run")

        self.horizontalLayout_95.addWidget(self.label_run)

        self.plc_run_reg_btn = QPushButton(self.frame_177)
        self.plc_run_reg_btn.setObjectName(u"plc_run_reg_btn")
        self.plc_run_reg_btn.setStyleSheet(u"")

        self.horizontalLayout_95.addWidget(self.plc_run_reg_btn)
        ...
        self.frame_178.setEnabled(False)
        ...
        self.line_stop = QLineEdit(self.frame_178)
        self.line_stop.setObjectName(u"line_stop")
        self.line_stop.setMaximumSize(QSize(300, 30))

        self.horizontalLayout_85.addWidget(self.line_stop)

        self.label_stop = QLabel(self.frame_178)
        self.label_stop.setObjectName(u"label_stop")

        self.horizontalLayout_85.addWidget(self.label_stop)

        self.plc_stop_reg_btn = QPushButton(self.frame_178)
        self.plc_stop_reg_btn.setObjectName(u"plc_stop_reg_btn")
        self.plc_stop_reg_btn.setStyleSheet(u"QPushButton{\n"
"background: green;\n"
"border: Transparent;\n"
"color:#ffffff;\n"
"}\n"
...
"}")
        ...
        self.horizontalLayout_85.addWidget(self.plc_stop_reg_btn)
        ...
        self.line_reject = QLineEdit(self.frame_179)
        self.line_reject.setObjectName(u"line_reject")
        self.line_reject.setMaximumSize(QSize(300, 30))

        self.horizontalLayout_96.addWidget(self.line_reject)

        self.label_reject = QLabel(self.frame_179)
        self.label_reject.setObjectName(u"label_reject")

        self.horizontalLayout_96.addWidget(self.label_reject)

        self.plc_reject_reg_btn = QPushButton(self.frame_179)
        self.plc_reject_reg_btn.setObjectName(u"plc_reject_reg_btn")
        self.plc_reject_reg_btn.setStyleSheet(u"QPushButton{\n"
"background: green;\n"
"border: Transparent;\n"
"color:#ffffff;\n"
"}\n"
...
"}")
        ...
        self.horizontalLayout_96.addWidget(self.plc_reject_reg_btn)
        ...
        self.line_18 = QFrame(self.frame_191)
        self.line_18.setObjectName(u"line_18")
        self.line_18.setFrameShape(QFrame.VLine)
        self.line_18.setFrameShadow(QFrame.Sunken)

        self.horizontalLayout_103.addWidget(self.line_18)

        self.spin_delay = QSpinBox(self.frame_191)
        self.spin_delay.setObjectName(u"spin_delay")
        self.spin_delay.setMinimumSize(QSize(60, 0))
        self.spin_delay.setMaximumSize(QSize(100, 16777215))
        self.spin_delay.setMaximum(1000000)

        self.horizontalLayout_103.addWidget(self.spin_delay)
        ...
        self.horizontalLayout_103.addItem(self.horizontalSpacer_39)

        self.horizontalSpacer_37 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_103.addItem(self.horizontalSpacer_37)
        ...
        self.line_32 = QFrame(self.frame_182)
        self.line_32.setObjectName(u"line_32")
        self.line_32.setFrameShape(QFrame.VLine)
        self.line_32.setFrameShadow(QFrame.Sunken)

        self.horizontalLayout_109.addWidget(self.line_32)

        self.spin_duration = QSpinBox(self.frame_182)
        self.spin_duration.setObjectName(u"spin_duration")
        self.spin_duration.setMinimumSize(QSize(60, 0))
        self.spin_duration.setMaximumSize(QSize(100, 16777215))
        self.spin_duration.setMaximum(100000000)

        self.horizontalLayout_109.addWidget(self.spin_duration)
        ...
        self.horizontalSpacer_40 = QSpacerItem(19, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.horizontalLayout_109.addItem(self.horizontalSpacer_40)

        self.horizontalSpacer_38 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_109.addItem(self.horizontalSpacer_38)


        self.verticalLayout_115.addWidget(self.frame_182)

        self.frame_227 = QFrame(self.frame_176)
        self.frame_227.setObjectName(u"frame_227")
        self.frame_227.setMinimumSize(QSize(500, 55))
        self.frame_227.setMaximumSize(QSize(16777215, 55))
        self.frame_227.setFrameShape(QFrame.Box)
        self.frame_227.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_200 = QHBoxLayout(self.frame_227)
        self.horizontalLayout_200.setObjectName(u"horizontalLayout_200")
        self.label_198 = QLabel(self.frame_227)
        self.label_198.setObjectName(u"label_198")
        self.label_198.setMaximumSize(QSize(110, 16777215))

        self.horizontalLayout_200.addWidget(self.label_198)

        self.line_spare = QLineEdit(self.frame_227)
        self.line_spare.setObjectName(u"line_spare")
        self.line_spare.setMaximumSize(QSize(300, 30))

        self.horizontalLayout_200.addWidget(self.line_spare)

        self.label_199 = QLabel(self.frame_227)
        self.label_199.setObjectName(u"label_199")
        self.label_199.setMaximumSize(QSize(50, 16777215))

        self.horizontalLayout_200.addWidget(self.label_199)

        self.label_spare = QLabel(self.frame_227)
        self.label_spare.setObjectName(u"label_spare")

        self.horizontalLayout_200.addWidget(self.label_spare)


        self.verticalLayout_115.addWidget(self.frame_227)
...
"	background-color: rgb(0, 0, 0);\n"
"}")
        self.checkall_plc_btns.setIcon(icon25)
...
"}")
        ...
        self.groupBox_16 = QGroupBox(self.frame_176)
        self.groupBox_16.setObjectName(u"groupBox_16")
        self.groupBox_16.setMinimumSize(QSize(0, 198))
        self.groupBox_16.setMaximumSize(QSize(16777215, 176))
...
"}")
        ...
        self.verticalLayout_115.addWidget(self.groupBox_16)
        ...
        self.verticalLayout_113.addWidget(self.groupBox_13, 0, Qt.AlignTop)


        self.verticalLayout_112.addWidget(self.frame_175, 0, Qt.AlignTop)


        self.verticalLayout_124.addWidget(self.frame_174, 0, Qt.AlignTop)
        ...
        self.page_detection_mode = QWidget()
        self.page_detection_mode.setObjectName(u"page_detection_mode")
        self.verticalLayout_38 = QVBoxLayout(self.page_detection_mode)
        self.verticalLayout_38.setObjectName(u"verticalLayout_38")
        self.frame_197 = QFrame(self.page_detection_mode)
        self.frame_197.setObjectName(u"frame_197")
        self.frame_197.setMinimumSize(QSize(0, 100))
        self.frame_197.setMaximumSize(QSize(16777215, 100))
        self.frame_197.setFrameShape(QFrame.StyledPanel)
        self.frame_197.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_222 = QHBoxLayout(self.frame_197)
        self.horizontalLayout_222.setObjectName(u"horizontalLayout_222")
        self.groupBox_29 = QGroupBox(self.frame_197)
        self.groupBox_29.setObjectName(u"groupBox_29")
        self.groupBox_29.setMinimumSize(QSize(185, 0))
        self.horizontalLayout_223 = QHBoxLayout(self.groupBox_29)
        self.horizontalLayout_223.setObjectName(u"horizontalLayout_223")
        self.checkbox_page_detection_sensor = QRadioButton(self.groupBox_29)
        self.checkbox_page_detection_sensor.setObjectName(u"checkbox_page_detection_sensor")

        self.horizontalLayout_223.addWidget(self.checkbox_page_detection_sensor)

        self.checkbox_page_detection_trigger = QRadioButton(self.groupBox_29)
        self.checkbox_page_detection_trigger.setObjectName(u"checkbox_page_detection_trigger")
        self.checkbox_page_detection_trigger.setChecked(True)

        self.horizontalLayout_223.addWidget(self.checkbox_page_detection_trigger)


        self.horizontalLayout_222.addWidget(self.groupBox_29)

        self.groupBox_15 = QGroupBox(self.frame_197)
        self.groupBox_15.setObjectName(u"groupBox_15")
        self.groupBox_15.setMinimumSize(QSize(170, 0))
        self.horizontalLayout_190 = QHBoxLayout(self.groupBox_15)
        self.horizontalLayout_190.setObjectName(u"horizontalLayout_190")
        self.checkbox_page_detection_mode_top = QRadioButton(self.groupBox_15)
        self.checkbox_page_detection_mode_top.setObjectName(u"checkbox_page_detection_mode_top")

        self.horizontalLayout_190.addWidget(self.checkbox_page_detection_mode_top)

        self.checkbox_page_detection_mode_side = QRadioButton(self.groupBox_15)
        self.checkbox_page_detection_mode_side.setObjectName(u"checkbox_page_detection_mode_side")
        self.checkbox_page_detection_mode_side.setChecked(True)

        self.horizontalLayout_190.addWidget(self.checkbox_page_detection_mode_side)


        self.horizontalLayout_222.addWidget(self.groupBox_15)

        self.camera_get_picture_detection_mode = QPushButton(self.frame_197)
        self.camera_get_picture_detection_mode.setObjectName(u"camera_get_picture_detection_mode")
        self.camera_get_picture_detection_mode.setMinimumSize(QSize(100, 30))
        self.camera_get_picture_detection_mode.setMaximumSize(QSize(100, 50))
        self.camera_get_picture_detection_mode.setCursor(QCursor(Qt.PointingHandCursor))
        self.camera_get_picture_detection_mode.setStyleSheet(u"QPushButton{\n"
"background: #1C95D8;\n"
"border: Transparent;\n"
"}\n"
"\n"
...
"}")
        ...
        self.horizontalLayout_222.addWidget(self.camera_get_picture_detection_mode)

        self.frame_261 = QFrame(self.frame_197)
        self.frame_261.setObjectName(u"frame_261")
        self.frame_261.setFrameShape(QFrame.NoFrame)
        self.frame_261.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_227 = QHBoxLayout(self.frame_261)
        self.horizontalLayout_227.setObjectName(u"horizontalLayout_227")
        self.line_50 = QFrame(self.frame_261)
        self.line_50.setObjectName(u"line_50")
        self.line_50.setFrameShape(QFrame.VLine)
        self.line_50.setFrameShadow(QFrame.Sunken)

        self.horizontalLayout_227.addWidget(self.line_50)

        self.label_225 = QLabel(self.frame_261)
        self.label_225.setObjectName(u"label_225")

        self.horizontalLayout_227.addWidget(self.label_225)

        self.thresh_min_detection_page = QSlider(self.frame_261)
        self.thresh_min_detection_page.setObjectName(u"thresh_min_detection_page")
        self.thresh_min_detection_page.setMinimumSize(QSize(0, 30))
        self.thresh_min_detection_page.setMaximumSize(QSize(100, 16777215))
        self.thresh_min_detection_page.setMinimum(1)
        self.thresh_min_detection_page.setMaximum(255)
        self.thresh_min_detection_page.setOrientation(Qt.Horizontal)

        self.horizontalLayout_227.addWidget(self.thresh_min_detection_page)

        self.spinBox_32 = QSpinBox(self.frame_261)
        self.spinBox_32.setObjectName(u"spinBox_32")
        self.spinBox_32.setMaximum(255)

        self.horizontalLayout_227.addWidget(self.spinBox_32)

        self.frame_262 = QFrame(self.frame_261)
        self.frame_262.setObjectName(u"frame_262")
        self.frame_262.setFrameShape(QFrame.NoFrame)
        self.frame_262.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_228 = QHBoxLayout(self.frame_262)
        self.horizontalLayout_228.setObjectName(u"horizontalLayout_228")
        self.label_226 = QLabel(self.frame_262)
        self.label_226.setObjectName(u"label_226")

        self.horizontalLayout_228.addWidget(self.label_226)

        self.thresh_max_detection_page = QSlider(self.frame_262)
        self.thresh_max_detection_page.setObjectName(u"thresh_max_detection_page")
        self.thresh_max_detection_page.setMinimumSize(QSize(0, 30))
        self.thresh_max_detection_page.setMaximumSize(QSize(100, 16777215))
        self.thresh_max_detection_page.setMinimum(1)
        self.thresh_max_detection_page.setMaximum(255)
        self.thresh_max_detection_page.setOrientation(Qt.Horizontal)

        self.horizontalLayout_228.addWidget(self.thresh_max_detection_page)

        self.spinBox_33 = QSpinBox(self.frame_262)
        self.spinBox_33.setObjectName(u"spinBox_33")
        self.spinBox_33.setMaximum(255)

        self.horizontalLayout_228.addWidget(self.spinBox_33)


        self.horizontalLayout_227.addWidget(self.frame_262)
        ...
        self.horizontalLayout_229 = QHBoxLayout(self.frame_263)
        self.horizontalLayout_229.setObjectName(u"horizontalLayout_229")
        self.label_227 = QLabel(self.frame_263)
        self.label_227.setObjectName(u"label_227")

        self.horizontalLayout_229.addWidget(self.label_227)

        self.spin_area_detection_page = QSpinBox(self.frame_263)
        self.spin_area_detection_page.setObjectName(u"spin_area_detection_page")
        self.spin_area_detection_page.setMaximum(10000)

        self.horizontalLayout_229.addWidget(self.spin_area_detection_page)


        self.horizontalLayout_227.addWidget(self.frame_263)

        self.horizontalSpacer_48 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_227.addItem(self.horizontalSpacer_48)


        self.horizontalLayout_222.addWidget(self.frame_261)

        self.horizontalSpacer_49 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_222.addItem(self.horizontalSpacer_49)


        self.verticalLayout_38.addWidget(self.frame_197)

        self.line_46 = QFrame(self.page_detection_mode)
        self.line_46.setObjectName(u"line_46")
        self.line_46.setFrameShape(QFrame.HLine)
        self.line_46.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_38.addWidget(self.line_46)

        self.frame_214 = QFrame(self.page_detection_mode)
        self.frame_214.setObjectName(u"frame_214")
        self.frame_214.setFrameShape(QFrame.StyledPanel)
        self.frame_214.setFrameShadow(QFrame.Sunken)
        self.frame_214.setLineWidth(1)
        self.horizontalLayout_224 = QHBoxLayout(self.frame_214)
        ...
        self.horizontalLayout_224.addItem(self.horizontalSpacer_50)

        self.camera_detection_mode_picture = QLabel(self.frame_214)
        self.camera_detection_mode_picture.setObjectName(u"camera_detection_mode_picture")
        sizePolicy2.setHeightForWidth(self.camera_detection_mode_picture.sizePolicy().hasHeightForWidth())
        self.camera_detection_mode_picture.setSizePolicy(sizePolicy2)
        self.camera_detection_mode_picture.setMaximumSize(QSize(700, 700))
        self.camera_detection_mode_picture.setScaledContents(True)

        self.horizontalLayout_224.addWidget(self.camera_detection_mode_picture)

        self.horizontalSpacer_51 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_224.addItem(self.horizontalSpacer_51)


        self.verticalLayout_38.addWidget(self.frame_214)

        self.frame_215 = QFrame(self.page_detection_mode)
        self.frame_215.setObjectName(u"frame_215")
        self.frame_215.setMaximumSize(QSize(16777215, 100))
        self.frame_215.setFrameShape(QFrame.StyledPanel)
        self.frame_215.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_225 = QHBoxLayout(self.frame_215)
        self.horizontalLayout_225.setObjectName(u"horizontalLayout_225")
        self.frame_260 = QFrame(self.frame_215)
        self.frame_260.setObjectName(u"frame_260")
        self.frame_260.setMaximumSize(QSize(255, 16777215))
        self.frame_260.setFrameShape(QFrame.StyledPanel)
        self.frame_260.setFrameShadow(QFrame.Raised)
        self.verticalLayout_133 = QVBoxLayout(self.frame_260)
        self.verticalLayout_133.setObjectName(u"verticalLayout_133")

        self.horizontalLayout_225.addWidget(self.frame_260)

        self.label_11 = QLabel(self.frame_215)
        self.label_11.setObjectName(u"label_11")

        self.horizontalLayout_225.addWidget(self.label_11)

        self.selected_area = QLabel(self.frame_215)
        self.selected_area.setObjectName(u"selected_area")

        self.horizontalLayout_225.addWidget(self.selected_area)

        self.horizontalSpacer_47 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_225.addItem(self.horizontalSpacer_47)

        self.btn_save_sensor_detection_page = QPushButton(self.frame_215)
        self.btn_save_sensor_detection_page.setObjectName(u"btn_save_sensor_detection_page")
        self.btn_save_sensor_detection_page.setMinimumSize(QSize(47, 51))
        self.btn_save_sensor_detection_page.setMaximumSize(QSize(47, 51))
        self.btn_save_sensor_detection_page.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_save_sensor_detection_page.setStyleSheet(u"background-color: rgb(0, 0, 0);")
        self.btn_save_sensor_detection_page.setIcon(icon30)
        self.btn_save_sensor_detection_page.setIconSize(QSize(47, 56))

        self.horizontalLayout_225.addWidget(self.btn_save_sensor_detection_page)


        self.verticalLayout_38.addWidget(self.frame_215)

        self.stackedWidget.addWidget(self.page_detection_mode)
        ...
        self.bar_thresh_max0_3_top.valueChanged.connect(self.spinBox_5.setValue)
        self.spinBox_5.valueChanged.connect(self.bar_thresh_max0_3_top.setValue)
        ...
        self.bar_thresh_min0_1_top.valueChanged.connect(self.spinBox_2.setValue)
        self.spinBox_2.valueChanged.connect(self.bar_thresh_min0_1_top.setValue)
        self.bar_thresh_max0_1_top.valueChanged.connect(self.spinBox_3.setValue)
        self.spinBox_3.valueChanged.connect(self.bar_thresh_max0_1_top.setValue)
        self.bar_thresh_min0_1_side.valueChanged.connect(self.spinBox_23.setValue)
        self.spinBox_23.valueChanged.connect(self.bar_thresh_min0_1_side.setValue)
        self.bar_thresh_max0_1_side.valueChanged.connect(self.spinBox_24.setValue)
        self.spinBox_24.valueChanged.connect(self.bar_thresh_max0_1_side.setValue)
        self.bar_thresh_max0_2_top.valueChanged.connect(self.spinBox_25.setValue)
        self.spinBox_25.valueChanged.connect(self.bar_thresh_max0_2_top.setValue)
        self.bar_thresh_min0_2_top.valueChanged.connect(self.spinBox_26.setValue)
        self.spinBox_26.valueChanged.connect(self.bar_thresh_min0_2_top.setValue)
        self.bar_edge_thresh0_1_top.valueChanged.connect(self.spinBox_27.setValue)
        self.spinBox_27.valueChanged.connect(self.bar_edge_thresh0_1_top.setValue)
        self.bar_thresh_min0_3_top.valueChanged.connect(self.spinBox_12.setValue)
        self.spinBox_12.valueChanged.connect(self.bar_thresh_min0_3_top.setValue)
        self.spinBox_28.valueChanged.connect(self.bar_thresh_max0_4_top.setValue)
        self.bar_thresh_max0_4_top.valueChanged.connect(self.spinBox_28.setValue)
        self.spinBox_29.valueChanged.connect(self.bar_thresh_min0_4_top.setValue)
        self.bar_thresh_min0_4_top.valueChanged.connect(self.spinBox_29.setValue)
        self.bar_thresh_max0_5_top.valueChanged.connect(self.spinBox_30.setValue)
        self.spinBox_30.valueChanged.connect(self.bar_thresh_max0_5_top.setValue)
        self.bar_thresh_min0_5_top.valueChanged.connect(self.spinBox_31.setValue)
        self.spinBox_31.valueChanged.connect(self.bar_thresh_min0_5_top.setValue)
        self.spinBox_22.valueChanged.connect(self.bar_noise_filter0_5_top.setValue)
        self.thresh_min_detection_page.valueChanged.connect(self.spinBox_32.setValue)
        self.spinBox_32.valueChanged.connect(self.thresh_min_detection_page.setValue)
        self.thresh_max_detection_page.valueChanged.connect(self.spinBox_33.setValue)
        self.spinBox_33.valueChanged.connect(self.thresh_max_detection_page.setValue)
    ...
    def retranslateUi(self, MainWindow):
...
#if QT_CONFIG(tooltip)
        self.side_detection_mode_btn.setToolTip(QCoreApplication.translate("MainWindow", u"Calibration Settings", None))
#endif // QT_CONFIG(tooltip)
        self.side_detection_mode_btn.setText("")
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.history_btn.setToolTip(QCoreApplication.translate("MainWindow", u"General Settings", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.connect_cameras_live_page.setText(QCoreApplication.translate("MainWindow", u"  Connect Cameras", None))
        self.disconnect_cameras_live_page.setText(QCoreApplication.translate("MainWindow", u"  Disconnect Cameras", None))
        ...
        self.reject_btn.setText(QCoreApplication.translate("MainWindow", u"Press", None))
        ...
        self.label_156.setText(QCoreApplication.translate("MainWindow", u"Top :", None))
        self.label_selected_screw_top_live.setText("")
        self.label_158.setText(QCoreApplication.translate("MainWindow", u"Side :", None))
        self.label_selected_screw_side_live.setText("")
        self.start_capture_live_page.setText(QCoreApplication.translate("MainWindow", u"Start", None))
        self.stop_capture_live_page.setText(QCoreApplication.translate("MainWindow", u"Stop", None))
        ...
        self.checkbox_page0_0_top.setText("")
        self.btn_page0_0_top.setText(QCoreApplication.translate("MainWindow", u"Main", None))
        self.checkbox_page0_1_top.setText("")
        self.btn_page0_1_top.setText(QCoreApplication.translate("MainWindow", u"Mask", None))
        ...
        self.label_202.setText(QCoreApplication.translate("MainWindow", u"Left Belt Position :", None))
        self.label_207.setText("")
        self.label_204.setText(QCoreApplication.translate("MainWindow", u"Right Belt Position :", None))
        self.label_205.setText(QCoreApplication.translate("MainWindow", u"Angle :", None))
        ...
        self.check_thresh_algo_1_top.setText(QCoreApplication.translate("MainWindow", u"Threshold", None))
        self.check_edge_algo_1_top.setText(QCoreApplication.translate("MainWindow", u"Edge", None))
        self.label_160.setText(QCoreApplication.translate("MainWindow", u"Edge Threshold", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Belt Edge Margin :", None))
        self.label_168.setText(QCoreApplication.translate("MainWindow", u"Max Threshold", None))
        self.label_54.setText(QCoreApplication.translate("MainWindow", u"Min Threshold", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Noise filter", None))
        self.label_212.setText(QCoreApplication.translate("MainWindow", u"D Parm1 :", None))
        self.label_213.setText(QCoreApplication.translate("MainWindow", u"E Parm2 :", None))
        self.label_214.setText(QCoreApplication.translate("MainWindow", u"D Parm3 :", None))
        self.label_215.setText(QCoreApplication.translate("MainWindow", u"E Parm4 :", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"ADD Area :", None))
        self.btn_add_region0_2_top.setText("")
        self.label_124.setText(QCoreApplication.translate("MainWindow", u"Select Area :", None))
        self.btn_edit_region0_2_top.setText("")
        self.btn_remove_region0_2_top.setText("")
        self.label_217.setText(QCoreApplication.translate("MainWindow", u"X :", None))
        self.label_218.setText(QCoreApplication.translate("MainWindow", u"Y :", None))
        self.label_219.setText(QCoreApplication.translate("MainWindow", u"Radius :", None))
        self.label_200.setText(QCoreApplication.translate("MainWindow", u"Max Threshold", None))
        self.label_201.setText(QCoreApplication.translate("MainWindow", u"Min Threshold", None))
        ...
        self.label_203.setText(QCoreApplication.translate("MainWindow", u"Select Area :", None))
        self.btn_remove_region0_3_top_2.setText("")
        ...
        self.label_138.setText(QCoreApplication.translate("MainWindow", u"Max Threshold", None))
        self.label_216.setText(QCoreApplication.translate("MainWindow", u"Min Threshold", None))
        ...
        self.label_220.setText(QCoreApplication.translate("MainWindow", u"Max Threshold", None))
        self.label_221.setText(QCoreApplication.translate("MainWindow", u"Min Threshold", None))
        ...
        self.label_223.setText(QCoreApplication.translate("MainWindow", u"Max Threshold :", None))
        self.label_224.setText(QCoreApplication.translate("MainWindow", u"Min Threshold :", None))
        ...
        self.label_197.setText(QCoreApplication.translate("MainWindow", u"Max Threshold", None))
        self.label_188.setText(QCoreApplication.translate("MainWindow", u"Min Threshold", None))
        ...
        self.label_126.setText(QCoreApplication.translate("MainWindow", u"Nafi : ", None))
        self.label_navel_3_side.setText(QCoreApplication.translate("MainWindow", u"-", None))
        self.label_170.setText(QCoreApplication.translate("MainWindow", u"Min", None))
        self.label_222.setText(QCoreApplication.translate("MainWindow", u"Max", None))
        ...
        self.check_top_5_side.setText(QCoreApplication.translate("MainWindow", u"Top", None))
        self.check_bottom_5_side.setText(QCoreApplication.translate("MainWindow", u"Bottom", None))
        ...
        self.btn_tools_live.setText(QCoreApplication.translate("MainWindow", u"Live", None))
        ...
        self.camera_setting_full_screen_top_camera.setText(QCoreApplication.translate("MainWindow", u"  FullScreen", None))
        ...
        self.camera_setting_full_screen_side_camera.setText(QCoreApplication.translate("MainWindow", u"  FullScreen", None))
        self.fullscreen_cam_side_btn.setText("")
        self.camera_setting_tools_page.setText(QCoreApplication.translate("MainWindow", u"Back to Tools Page", None))
        ...
        self.label_208.setText(QCoreApplication.translate("MainWindow", u"Pixel Size :", None))
        self.label_210.setText(QCoreApplication.translate("MainWindow", u"mm", None))
        ...
        self.label_209.setText(QCoreApplication.translate("MainWindow", u"Pixel Size :", None))
        self.label_211.setText(QCoreApplication.translate("MainWindow", u"mm", None))
        ...
        self.label_run.setText(QCoreApplication.translate("MainWindow", u"-", None))
        self.plc_run_reg_btn.setText(QCoreApplication.translate("MainWindow", u"On", None))
        self.label_157.setText(QCoreApplication.translate("MainWindow", u"Stop :", None))
        self.label_stop.setText(QCoreApplication.translate("MainWindow", u"-", None))
        self.plc_stop_reg_btn.setText(QCoreApplication.translate("MainWindow", u"On", None))
        self.label_159.setText(QCoreApplication.translate("MainWindow", u"Reject :", None))
        self.label_reject.setText(QCoreApplication.translate("MainWindow", u"-", None))
        self.plc_reject_reg_btn.setText(QCoreApplication.translate("MainWindow", u"On", None))
        self.label_175.setText(QCoreApplication.translate("MainWindow", u"Start time delay :", None))
        self.label_164.setText(QCoreApplication.translate("MainWindow", u"ms", None))
        self.label_165.setText(QCoreApplication.translate("MainWindow", u"Duration of being on :", None))
        self.label_166.setText(QCoreApplication.translate("MainWindow", u"ms", None))
        self.label_198.setText(QCoreApplication.translate("MainWindow", u"Spare :", None))
        self.label_199.setText(QCoreApplication.translate("MainWindow", u"Value :", None))
        self.label_spare.setText(QCoreApplication.translate("MainWindow", u"-", None))
        self.checkall_plc_btns.setText("")
        ...
        self.groupBox_29.setTitle(QCoreApplication.translate("MainWindow", u"Mode :", None))
        self.checkbox_page_detection_sensor.setText(QCoreApplication.translate("MainWindow", u"Sensor", None))
        self.checkbox_page_detection_trigger.setText(QCoreApplication.translate("MainWindow", u"Software", None))
        self.groupBox_15.setTitle(QCoreApplication.translate("MainWindow", u"Select Camera :", None))
        self.checkbox_page_detection_mode_top.setText(QCoreApplication.translate("MainWindow", u"Top", None))
        self.checkbox_page_detection_mode_side.setText(QCoreApplication.translate("MainWindow", u"Side", None))
        self.camera_get_picture_detection_mode.setText(QCoreApplication.translate("MainWindow", u"Get Picture", None))
        self.label_225.setText(QCoreApplication.translate("MainWindow", u"Thresh min :", None))
        self.label_226.setText(QCoreApplication.translate("MainWindow", u"Thresh max :", None))
        self.label_227.setText(QCoreApplication.translate("MainWindow", u"Area :", None))
        self.camera_detection_mode_picture.setText("")
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Area : ", None))
        self.selected_area.setText(QCoreApplication.translate("MainWindow", u"-", None))
        self.btn_save_sensor_detection_page.setText("")
